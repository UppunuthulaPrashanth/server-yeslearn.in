...
class AdvertisingBannersController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.advertising_banners_list'),
            'banners' => $banners
        ];
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.new_banner')
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/advertising/banners');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.edit'),
            'banner' => $banner
        ];
