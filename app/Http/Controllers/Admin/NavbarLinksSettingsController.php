...
class NavbarLinksSettingsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.additional_pages_title'),
            'items' => $items,
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/additional_page/navbar_links');
    }
    ...
    public function edit(Request $request, $link_key)
    {
        ...
        if (!empty($settings)) {
            ...
            $data = [
                'pageTitle' => trans('oraclepopupsignin/pages/setting.settings_navbar_links'),
                'navbar_link' => $result,
