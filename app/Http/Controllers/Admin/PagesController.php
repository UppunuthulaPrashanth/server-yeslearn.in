...
class PagesController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/setting.pages'),
            'pages' => $pages
        ];
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/setting.new_pages')
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/pages');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/setting.edit_pages') . $page->name,
            'page' => $page
        ];
