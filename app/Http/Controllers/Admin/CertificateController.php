...
class CertificateController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.certificate_list_page_title'),
    ...
    public function CertificatesTemplatesList(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.certificate_templates_list_page_title'),
            'templates' => $templates,
        ];
    ...
    public function CertificatesNewTemplate()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.certificate_new_template_page_title'),
        ];
    ...
    public function CertificatesTemplatesEdit(Request $request, $template_id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.certificate_template_edit_page_title'),
            'template' => $template
        ];
        return view('admin.certificates.new_templates', $data);
    }
    ...
    public function CertificatesTemplatesDelete($template_id)
    {
        ...
        return redirect('/oraclepopupsignin/certificates/templates');
    }
