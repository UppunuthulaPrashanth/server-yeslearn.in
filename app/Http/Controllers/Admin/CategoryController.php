...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/categories.categories_list_page_title'),
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.category_new_page_title'),
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/categories');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/categories.edit_page_title'),
            'category' => $category,
