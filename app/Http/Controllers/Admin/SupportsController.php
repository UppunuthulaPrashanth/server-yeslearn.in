...
class SupportsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/users.supports'),
            'supports' => $supports,
        ...
        if (!empty($request->get('type')) and $request->get('type') == 'course_conversations') {
            $data['pageTitle'] = trans('oraclepopupsignin/main.classes_conversations');
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.new_support_ticket_title'),
            'departments' => $departments,
            'toUser' => $toUser
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/supports/' . $support->id . '/conversation');
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.edit_support_ticket_title'),
            'departments' => $departments,
            'support' => $support,
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/oraclepopupsignin/supports');
    }
    ...
    public function conversation($id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/users.support_conversation'),
            'support' => $support
        ];
