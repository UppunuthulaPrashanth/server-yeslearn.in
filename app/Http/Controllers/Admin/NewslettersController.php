...
class NewslettersController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.newsletters'),
    ...
    public function sendNewsletter(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/newsletters/history');
    }
    ...
    public function exportExcel()
    {
        ...
        return Excel::download($newslettersExport, trans('oraclepopupsignin/main.newsletters') . '.xlsx');
    }
}
