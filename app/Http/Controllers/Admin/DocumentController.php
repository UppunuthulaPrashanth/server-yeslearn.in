...
class DocumentController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/financial.document_page_title'),
            'documents' => $documents,
            'users' => $users,
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/financial.new_document_page_title'),
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/financial/documents');
    }
