...
class PaymentChannelController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/paymentChannels.payment_channels'),
    ...
    public function edit($id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/paymentChannels.payment_channel_edit'),
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/oraclepopupsignin/settings/financial');
    }
