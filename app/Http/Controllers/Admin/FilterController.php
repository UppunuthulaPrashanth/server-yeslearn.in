...
class FilterController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.filters_list_page_title'),
            'filters' => $filters
        ];
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.filter_new_page_title'),
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/filters');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.admin_filters_edit'),
            'filter' => $filter,
            'categories' => $categories,
