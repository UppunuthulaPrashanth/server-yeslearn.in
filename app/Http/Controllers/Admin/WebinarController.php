...
class WebinarController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/webinars.webinars_list_page_title'),
            'webinars' => $webinars,
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.webinar_new_page_title'),
            'teachers' => $teachers,
            'categories' => $categories
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/webinars/' . $webinar->id . '/edit?locale=' . $data['locale']);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.edit') . ' | ' . $webinar->title,
            'teachers' => $teachers,
            'categories' => $categories,
            'webinar' => $webinar,
        ...
        if (!empty($data['teacher_id'])) {
            ...
            if (empty($teacher) or ($creator->isOrganization() and ($teacher->organ_id != $creator->id and $teacher->id != $creator->id))) {
                $toastData = [
                    ...
                    'msg' => trans('oraclepopupsignin/main.is_not_the_teacher_of_this_organization'),
                    'status' => 'error'
                ];
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect('/oraclepopupsignin/webinars');
    }
