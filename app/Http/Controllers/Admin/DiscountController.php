...
class DiscountController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.discount_codes_title'),
            'discounts' => $discounts,
        ];
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.new_discount_title'),
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/financial/discounts');
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.edit_discount_title'),
            'discount' => $discount,
