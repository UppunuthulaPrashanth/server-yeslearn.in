...
class RoleController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/roles.page_lists_title'),
            'roles' => $roles,
        ];
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.role_new_page_title'),
            'sections' => $sections
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/roles');
    }
