...
class NotificationsController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.notifications'),
    ...
    public function posted()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.posted_notifications'),
            'notifications' => $notifications
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/notifications/posted');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/oraclepopupsignin/notifications');
    }
