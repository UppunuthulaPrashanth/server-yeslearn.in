...
class PromotionsController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/financial.promotions'),
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/financial.new_promotion')
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/financial/promotions');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/financial.edit_promotion'),
            'promotion' => $promotion
        ];
    ...
    public function sales(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/financial.promotion_sales'),
