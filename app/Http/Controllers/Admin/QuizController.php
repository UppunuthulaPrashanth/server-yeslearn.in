...
class QuizController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/quiz.admin_quizzes_list'),
            'quizzes' => $quizzes,
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($webinar)) {
            ...
            return back()->withErrors([
                'webinar_id' => trans('validation.exists', ['attribute' => trans('oraclepopupsignin/main.course')])
            ]);
        }
    }
    ...
    public function results($id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/quizResults.quiz_result_list_page_title'),
