...
class NoticeboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.notices_list_title'),
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.new_notice_title')
        ];
    ...
    public function store(Request $request)
    {
        ...
        $toastData = [
            ...
            'msg' => trans('oraclepopupsignin/main.send_noticeboard_success'),
            'status' => 'success'
        ];
        return redirect('/oraclepopupsignin/noticeboards')->with(['toast' => $toastData]);
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.edit_noticeboard'),
    ...
    public function update(Request $request,$id)
    {
        ...
        $toastData = [
            'title' => trans('public.request_success'),
            'msg' => trans('oraclepopupsignin/main.edit_noticeboard_success'),
            'status' => 'success'
        ];
        return redirect('/oraclepopupsignin/noticeboards')->with(['toast' => $toastData]);
    }
    ...
    public function delete($id)
    {
        ...
        $toastData = [
            'title' => trans('public.request_success'),
            'msg' => trans('oraclepopupsignin/main.delete_noticeboard_success'),
            'status' => 'success'
        ];
        return redirect('/oraclepopupsignin/noticeboards')->with(['toast' => $toastData]);
    }
