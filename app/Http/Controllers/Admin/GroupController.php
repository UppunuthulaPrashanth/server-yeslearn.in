...
class GroupController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/groups.group_list_page_title'),
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.group_new_page_title'),
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/users/groups');
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/groups.edit_page_title'),
            'group' => $group,
