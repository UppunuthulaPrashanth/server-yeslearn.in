...
class CommentsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'page' => $this->page,
            'pageTitle' => trans('oraclepopupsignin/pages/comments.' . ($this->page == 'webinars' ? 'classes_comments' : 'blog_comments')),
            'comments' => $comments,
    ...
    public function edit($page, $comment_id)
    {
        ...
        if (!empty($comment)) {
            $data = [
                'pageTitle' => trans('oraclepopupsignin/pages/comments.edit_comment'),
                'itemRelation' => $this->item,
                'page' => $this->page,
                'comment' => $comment,
            ];
    ...
    public function reply($page, $comment_id)
    {
        ...
        if (!empty($comment)) {
            $data = [
                'pageTitle' => trans('oraclepopupsignin/pages/comments.reply_comment'),
                'itemRelation' => $this->item,
                'page' => $this->page,
                'comment' => $comment,
            ];
    ...
    public function reports()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/comments.comments_reports'),
            'itemRelation' => $this->item,
            'page' => $this->page,
            'reports' => $reports,
        ];
