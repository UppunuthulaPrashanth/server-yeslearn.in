...
class OfflinePaymentController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.offline_payments_title') . (($pageType == 'requests') ? 'Requests' : 'History'),
    ...
    public function approved($id)
    {
        ...
        Accounting::create([
            ...
            'description' => trans('oraclepopupsignin/pages/setting.notification_offline_payment_approved'),
            'created_at' => time(),
        ]);
