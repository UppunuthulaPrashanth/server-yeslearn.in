...
class SupportDepartmentsController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.support_departments_title'),
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/users.new_department'),
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/supports/departments');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/users.edit_department'),
