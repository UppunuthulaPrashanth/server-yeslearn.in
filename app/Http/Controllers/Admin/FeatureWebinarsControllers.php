...
class FeatureWebinarsControllers extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/webinars.feature_webinars'),
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('public.create') . ' ' . trans('oraclepopupsignin/pages/webinars.feature_webinars'),
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/webinars/features');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('public.edit') . ' ' . trans('oraclepopupsignin/pages/webinars.feature_webinars'),
            'feature' => $feature
        ];
