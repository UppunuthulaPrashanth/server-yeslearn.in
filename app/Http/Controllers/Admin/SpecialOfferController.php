...
class SpecialOfferController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/financial.special_offers_list_page_title'),
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.new_product_discount_title'),
            'webinars' => $webinars,
        ];
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/oraclepopupsignin/financial/special_offers');
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.edit_product_discount_title'),
