...
class UserController extends Controller
{
    public function staffs(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.staff_list_title'),
            'users' => $users,
    ...
    public function organizations(Request $request, $is_export_excel = false)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.organizations'),
            'users' => $users,
    ...
    public function instructors(Request $request, $is_export_excel = false)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.instructors'),
            'users' => $users,
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/main.user_new_page_title'),
            'roles' => $roles,
            'userGroups' => $userGroups,
        ];
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($data['role_id'])) {
            ...
            if (!empty($role)) {
                ...
                return redirect('/oraclepopupsignin/users/' . $user->id . '/edit');
            }
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('oraclepopupsignin/pages/users.edit_page_title'),
            'user' => $user,
    ...
    public function acceptRequestToInstructor($id)
    {
        ...
        if (!empty($becomeInstructors)) {
            ...
            return redirect('/oraclepopupsignin/users/' . $user->id . '/edit')->with(['msg' => trans('oraclepopupsignin/pages/users.user_role_updated')]);
        }
    ...
    public function impersonate($user_id)
    {
        ...
        if ($user->isAdmin()) {
            return redirect('/oraclepopupsignin');
        }
