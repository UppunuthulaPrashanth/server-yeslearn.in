...
class ReferralUsersExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function headings(): array
    {
        return [
            ...
            trans('oraclepopupsignin/main.user_group'),
            trans('oraclepopupsignin/main.referral_code'),
            trans('oraclepopupsignin/main.amount'),
            trans('oraclepopupsignin/main.commission'),
    ...
    public function map($referral): array
    {
        ...
        return [
            ...
            $referral->affiliateUser->affiliate ? trans('oraclepopupsignin/main.yes') : trans('oraclepopupsignin/main.no'),
        ];
    }
}
