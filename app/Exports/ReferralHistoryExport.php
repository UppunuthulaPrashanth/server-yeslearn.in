...
class ReferralHistoryExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    {
        return [
            trans('oraclepopupsignin/main.affiliate_user'),
            trans('oraclepopupsignin/main.referred_user'),
            trans('oraclepopupsignin/main.total_affiliate_amount'),
            trans('oraclepopupsignin/main.total_affiliate_commission'),
            trans('oraclepopupsignin/main.total_referred_amount'),
