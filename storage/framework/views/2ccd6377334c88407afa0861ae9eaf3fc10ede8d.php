            ...
            <?php $__currentLoopData = $textLessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $textLesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="accordion-row rounded-sm border mt-20 p-15">
                    <div class="d-flex align-items-center justify-content-between" role="tab" id="textLessons_<?php echo e($textLesson->id); ?>">
                        <div class="d-flex align-items-center" href="#collapseTextLessons<?php echo e($textLesson->id); ?>" aria-controls="collapseTextLessons<?php echo e($textLesson->id); ?>" data-parent="#textLessonsAccordion" role="button" data-toggle="collapse" aria-expanded="true">
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/web/default/course/tabs/contents/text_lessons.blade.php ENDPATH**/ ?>