...
<div class="d-none" id="webinarSessionModal">
    ...
    <form action="/oraclepopupsignin/sessions/store" method="post" class="session-form">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <div class="js-zoom-not-complete-alert mt-10 text-danger d-none">
                <?php echo e(trans('oraclepopupsignin/main.teacher_zoom_jwt_token_invalid')); ?>
        ...
        <div class="form-group">
            ...
            <select class="custom-select" name="chapter_id">
                <option value=""><?php echo e(trans('oraclepopupsignin/main.no_chapter')); ?></option>
        ...
        <div class="js-session-status form-group mt-3">
            <div class="d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="sessionStatusSwitch_record"><?php echo e(trans('oraclepopupsignin/main.active')); ?></label>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/webinars/modals/session.blade.php ENDPATH**/ ?>