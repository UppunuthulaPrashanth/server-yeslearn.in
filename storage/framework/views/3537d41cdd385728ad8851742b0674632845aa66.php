    ...
    <div class="<?php echo e((!empty($isPanel) and $isPanel) ? 'container-fluid' : 'container'); ?>">
        <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <div class="nav-icons-or-start-live navbar-order">
                ...
                <a href="<?php echo e(empty($authUser) ? '/login' : ($authUser->isAdmin() ? '/oraclepopupsignin/webinars/create' : (($authUser->isUser()) ? '/become-instructor' : '/panel/webinars/new'))); ?>" class="d-none d-lg-flex btn btn-sm btn-primary nav-start-a-live-btn">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/yeslearn.in/public_html/resources/views/web/default/includes/navbar.blade.php ENDPATH**/ ?>