    ...
    <li class="dropdown dropdown-list-toggle">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_notifications_list')): ?>
            <li class="dropdown dropdown-list-toggle">
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right">
                    <div class="dropdown-header"><?php echo e(trans('oraclepopupsignin/main.notifications')); ?>

                        <div class="float-right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_notifications_markAllRead')): ?>
                                <a href="/oraclepopupsignin/notifications/mark_all_read"><?php echo e(trans('oraclepopupsignin/main.mark_all_read')); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="dropdown-list-content dropdown-list-icons">
                        <?php $__currentLoopData = $unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unreadNotification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="/oraclepopupsignin/notifications" class="dropdown-item">
                                <div class="dropdown-item-icon bg-info text-white d-flex align-items-center justify-content-center">
                    ...
                    <div class="dropdown-footer text-center">
                        <a href="/oraclepopupsignin/notifications"><?php echo e(trans('oraclepopupsignin/main.view_all')); ?> <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
            </li>
        <?php endif; ?>
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                 ...
                 <a href="/" class="dropdown-item has-icon">
                    <i class="fas fa-globe"></i> <?php echo e(trans('oraclepopupsignin/main.show_website')); ?>

                </a>

                <a href="/oraclepopupsignin/users/<?php echo e($authUser->id); ?>/edit" class="dropdown-item has-icon">
                    <i class="fas fa-cog"></i> <?php echo e(trans('oraclepopupsignin/main.change_password')); ?>

                </a>

                <div class="dropdown-divider"></div>
                <a href="/oraclepopupsignin/logout" class="dropdown-item has-icon text-danger">
                    <i class="fas fa-sign-out-alt"></i> <?php echo e(trans('oraclepopupsignin/main.logout')); ?>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/includes/navbar.blade.php ENDPATH**/ ?>