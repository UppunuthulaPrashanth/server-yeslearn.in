...
<?php $__env->startSection('content'); ?>
    <section class="section">
        <div class="section-header">
            <h1><?php echo e(!empty($webinar) ?trans('/oraclepopupsignin/main.edit'): trans('oraclepopupsignin/main.new')); ?> <?php echo e(trans('oraclepopupsignin/main.class')); ?></h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="/oraclepopupsignin/webinars"><?php echo e(trans('oraclepopupsignin/main.classes')); ?></a>
                </div>
                <div class="breadcrumb-item"><?php echo e(!empty($webinar) ?trans('/oraclepopupsignin/main.edit'): trans('oraclepopupsignin/main.new')); ?></div>
            </div>
        </div>
                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="/oraclepopupsignin/webinars/<?php echo e(!empty($webinar) ? $webinar->id.'/update' : 'store'); ?>" id="webinarForm" class="webinar-form">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15">
                                                <label class="input-label"><?php echo e(trans('oraclepopupsignin/main.class_url')); ?></label>
...
unset($__errorArgs, $__bag); ?>" placeholder=""/>
                                                <div class="text-muted text-small mt-1"><?php echo e(trans('oraclepopupsignin/main.class_url_hint')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php if(!empty($webinar) and $webinar->creator->isOrganization()): ?>
                                                <div class="form-group mt-15 ">
                                                    <label class="input-label d-block"><?php echo e(trans('oraclepopupsignin/main.organization')); ?></label>
                                            ...
                                            <div class="form-group mt-15 ">
                                                <label class="input-label d-block"><?php echo e(trans('oraclepopupsignin/main.select_a_instructor')); ?></label>
...
unset($__errorArgs, $__bag); ?>"/>
                                                <div class="text-muted text-small mt-1"><?php echo e(trans('oraclepopupsignin/main.seo_description_hint')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div id="partnerInstructorInput" class="form-group mt-15 <?php echo e(!empty($webinar) && $webinar->partner_instructor ? '' : 'd-none'); ?>">
                                                ...
                                                <div class="text-muted text-small mt-1"><?php echo e(trans('oraclepopupsignin/main.select_a_partner_hint')); ?></div>
                                            </div>

                                            <div class="form-group mt-15">
                                                <label class="input-label d-block"><?php echo e(trans('public.tags')); ?></label>
                                                <input type="text" name="tags" data-max-tag="5" value="<?php echo e(!empty($webinar) ? implode(',',$webinarTags) : ''); ?>" class="form-control inputtags" placeholder="<?php echo e(trans('public.type_tag_name_and_press_enter')); ?> (<?php echo e(trans('oraclepopupsignin/main.max')); ?> : 5)"/>
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if(!empty($webinar)): ?>
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h2 class="section-title after-line"><?php echo e(trans('oraclepopupsignin/main.price_plans')); ?></h2>
                                            <button id="webinarAddTicket" type="button" class="btn btn-primary btn-sm mt-3"><?php echo e(trans('oraclepopupsignin/main.add_price_plan')); ?></button>
                                        </div>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" data-ticket-id="<?php echo e($ticket->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-ticket btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('oraclepopupsignin/main.edit')); ?>">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/tickets/'. $ticket->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if(!empty($chapters) and !$chapters->isEmpty()): ?>
                                                    <div class="table-responsive">
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <tr>
                                                                <th><?php echo e(trans('public.title')); ?></th>
                                                                <th><?php echo e(trans('oraclepopupsignin/main.type')); ?></th>
                                                            ...
                                                            <?php $__currentLoopData = $chapters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <th><?php echo e(trans('oraclepopupsignin/main.'.$chapter->type)); ?></th>
                                                                    <th><?php echo e($chapter->getTopicsCount()); ?></th>
                                                                    <th><?php echo e(trans('oraclepopupsignin/main.'.$chapter->status)); ?></th>

                                                                    <td class="text-right">
                                                                        <button type="button" data-chapter-id="<?php echo e($chapter->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-chapter btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('oraclepopupsignin/main.edit')); ?>">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/chapters/'. $chapter->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php if(!empty($sessions) and !$sessions->isEmpty()): ?>
                                                        <div class="table-responsive">
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                <tr>
                                                                    <th><?php echo e(trans('public.title')); ?></th>
                                                                    <th><?php echo e(trans('oraclepopupsignin/main.session_api')); ?></th>
                                                                ...
                                                                <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo e($session->duration); ?> <?php echo e(trans('oraclepopupsignin/main.min')); ?></td>
                                                                        <td><?php echo e($session->getJoinLink()); ?></td>
                                                                        <th><?php echo e(trans('oraclepopupsignin/main.'.$session->status)); ?></th>
                                                                        <td>
                                                                            <button type="button" data-session-id="<?php echo e($session->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-session btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('oraclepopupsignin/main.edit')); ?>">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>

                                                                            <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/sessions/'. $session->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                        </td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <th><?php echo e(trans('oraclepopupsignin/main.'.$file->status)); ?></th>
                                                                    <td>
                                                                        <button type="button" data-file-id="<?php echo e($file->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-file btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('oraclepopupsignin/main.edit')); ?>">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/files/'. $file->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php if(count($textLesson->attachments) > 0): ?>
                                                                                <span class="text-success"><?php echo e(trans('oraclepopupsignin/main.yes')); ?> (<?php echo e(count($textLesson->attachments)); ?>)</span>
                                                                            <?php else: ?>
                                                                                <span class="text-dark"><?php echo e(trans('oraclepopupsignin/main.no')); ?></span>
                                                                            <?php endif; ?>
                                                                        </td>
                                                                        <td><?php echo e($textLesson->accessibility); ?></td>
                                                                        <th><?php echo e(trans('oraclepopupsignin/main.'.$textLesson->status)); ?></th>
                                                                        <td>
                                                                            <button type="button" data-text-id="<?php echo e($textLesson->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-test-lesson btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('oraclepopupsignin/main.edit')); ?>">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>

                                                                            <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/test-lesson/'. $textLesson->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                        </td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php $__currentLoopData = $prerequisites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prerequisite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if(!empty($prerequisite->prerequisiteWebinar->title)): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button" data-prerequisite-id="<?php echo e($prerequisite->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-prerequisite btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('oraclepopupsignin/main.edit')); ?>">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>

                                                                            <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/prerequisites/'. $prerequisite->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                        </td>
                                                                    </tr>
                                                                <?php endif; ?>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <button type="button" data-faq-id="<?php echo e($faq->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-faq btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('oraclepopupsignin/main.edit')); ?>">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/faqs/'. $faq->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $webinarQuizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webinarQuiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" data-webinar-quiz-id="<?php echo e($webinarQuiz->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-webinar-quiz btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('oraclepopupsignin/main.edit')); ?>">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/webinar-quiz/'. $webinarQuiz->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    </td>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </tr>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish" class="btn btn-success"><?php echo e(!empty($webinar) ? trans('oraclepopupsignin/main.save_and_publish') : trans('oraclepopupsignin/main.save_and_continue')); ?></button>

                                        <?php if(!empty($webinar)): ?>
                                            <button type="button" id="saveReject" class="btn btn-warning"><?php echo e(trans('public.reject')); ?></button>

                                            <?php echo $__env->make('admin.includes.delete_button',[
                                                    'url' => '/oraclepopupsignin/webinars/'. $webinar->id .'/delete',
...
<?php $__env->startPush('scripts_bottom'); ?>
    <script>
        ...
        var zoomJwtTokenInvalid = '<?php echo e(trans('oraclepopupsignin/main.teacher_zoom_jwt_token_invalid')); ?>';
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/webinars/create.blade.php ENDPATH**/ ?>