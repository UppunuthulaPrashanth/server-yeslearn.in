<div class="tab-pane mt-3 fade <?php if(empty($becomeInstructor)): ?> active show <?php endif; ?>" id="general" role="tabpanel" aria-labelledby="general-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/users/<?php echo e($user->id .'/update'); ?>" method="Post">
                <?php echo e(csrf_field()); ?>


                <div class="form-group">
                    <label><?php echo e(trans('/oraclepopupsignin/main.full_name')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                           ...
                           placeholder="<?php echo e(trans('oraclepopupsignin/main.create_field_full_name_placeholder')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label><?php echo e(trans('/oraclepopupsignin/main.role_name')); ?></label>
...
unset($__errorArgs, $__bag); ?>" id="roleId" name="role_id">
                        <option disabled <?php echo e(empty($user) ? 'selected' : ''); ?>><?php echo e(trans('oraclepopupsignin/main.select_role')); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if($user->isUser() || $user->isTeacher()): ?>
                    <div class="form-group">
                        ...
                        <select name="organ_id" data-search-option="just_organization_role" class="form-control search-user-select2"
                                data-placeholder="<?php echo e(trans('oraclepopupsignin/main.search')); ?> <?php echo e(trans('oraclepopupsignin/main.organization')); ?>">
                ...
                <div class="form-group">
                    <label for="username"><?php echo e(trans('oraclepopupsignin/main.email')); ?>:</label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label for="username"><?php echo e(trans('oraclepopupsignin/main.mobile')); ?>:</label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label><?php echo e(trans('oraclepopupsignin/main.password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label><?php echo e(trans('oraclepopupsignin/main.bio')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label><?php echo e(trans('/oraclepopupsignin/main.status')); ?></label>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status">
                        <option disabled <?php echo e(empty($user) ? 'selected' : ''); ?>><?php echo e(trans('oraclepopupsignin/main.select_status')); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="banSwitch"><?php echo e(trans('oraclepopupsignin/main.ban')); ?></label>
                    </label>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="verified"><?php echo e(trans('oraclepopupsignin/main.enable_blue_badge')); ?></label>
                    </label>
                </div>
                ...
                <div class="form-group col-4">
                    ...
                    <input name="rank" type="number" value="<?php echo e($user->rank); ?>" class="form-control <?php $__errorArgs = ['rank'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class=" mt-4">
                    <button class="btn btn-primary"><?php echo e(trans('oraclepopupsignin/main.submit')); ?></button>
                </div>
            </form>
        </div>
    </div>
</div>
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/users/editTabs/general.blade.php ENDPATH**/ ?>