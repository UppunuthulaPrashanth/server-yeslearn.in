        ...
        <div class="d-flex flex-wrap align-items-stretch">
            <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                <div class="p-4 m-3">
                    ...
                    <form method="POST" action="<?php echo e(url('/oraclepopupsignin/login')); ?>" class="needs-validation" novalidate="">
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Yeslearn.in</h1>
                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
              </div>
              All rights reserved for <a class="text-light bb" target="_blank" href="https://yeslearn.in">Yeslearn.in</a> 
            </div>
          </div>
            </div>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>