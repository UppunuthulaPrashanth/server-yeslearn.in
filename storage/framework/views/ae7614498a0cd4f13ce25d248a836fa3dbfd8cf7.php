...
<div class="d-none" id="webinarTestLessonModal">
    ...
    <form action="/oraclepopupsignin/test-lesson/store" method="post">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="js-textLesson-status form-group mt-3">
            <div class="d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="textLessonStatusSwitch_record"><?php echo e(trans('oraclepopupsignin/main.active')); ?></label>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/webinars/modals/testLesson.blade.php ENDPATH**/ ?>