...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                ...
                <div class="col-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500"> Refferals </span>
                    </div>
                </div>
                <div class="col-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/48.svg" width="64" height="64" alt="">
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e($referredPartnerUsersCount); ?></strong>
                        <span class="font-16 text-gray font-weight-500">Partners </span>
                    </div>
                </div>
    ...
    <section class="mt-25">
        <h2 class="section-title"><?php echo e(trans('panel.affiliate_summary')); ?> <img src="<?php echo e($affiliateRank->icon); ?>" alt="" style="height:40px; border-radius:50px"></h2>

        <?php if(!empty($referralSettings)): ?>
            <div class="mt-15 font-14 text-gray">
                <div class="row">
                    <div class="col-md-4">
                        <p>Plan Name : <?php echo e($affiliateRank->label); ?></p>
                        <p>Description : <?php echo e($affiliateRank->Description); ?></p>
                    </div>
                    <div class="col-md-4">
                        <p>Direct commission on sale : <?php echo e($affiliateRank->direct_commi); ?> %</p>
                        <p>Partner commission on sale : <?php echo e($affiliateRank->partner_commi); ?> %</p>
                    </div>
                
                <div class="col-md-4">
                    <p><?php echo e(trans('panel.your_affiliate_code')); ?>: <span class="btn btn-warning btn-sm"><?php echo e($affiliateCode->code); ?></button></p>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yeslearn.in/public_html/resources/views/web/default/panel/marketing/affiliates.blade.php ENDPATH**/ ?>