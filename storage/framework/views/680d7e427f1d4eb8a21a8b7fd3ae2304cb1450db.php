...
<div class="d-none" id="webinarTicketModal">
    ...
    <form action="/oraclepopupsignin/tickets/store" method="post">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <div class="invalid-feedback"></div>
            <div class="text-muted text-small mt-1"><?php echo e(trans('oraclepopupsignin/main.price_plan_modal_capacity_hint')); ?></div>
        </div>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/webinars/modals/ticket.blade.php ENDPATH**/ ?>