            ...
            <div class="col-12 mb-4">
                <div class="hero text-white hero-bg-image hero-bg" data-background="<?php echo e(!empty(getPageBackgroundSettings('admin_dashboard')) ? getPageBackgroundSettings('admin_dashboard') : ''); ?>">
                    <div class="hero-inner">
                        <h2><?php echo e(trans('oraclepopupsignin/main.welcome')); ?>, <?php echo e($authUser->full_name); ?>!</h2>

                        <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_quick_access_links')): ?>
                                <div>
                                    <p class="lead"><?php echo e(trans('oraclepopupsignin/main.welcome_card_text')); ?></p>

                                    <div class="mt-2 mb-2 d-flex flex-column flex-md-row">
                                        <a href="/oraclepopupsignin/comments/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="far fa-comment"></i><?php echo e(trans('oraclepopupsignin/main.comments')); ?> </a>
                                        <a href="/oraclepopupsignin/supports" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="far fa-envelope"></i><?php echo e(trans('oraclepopupsignin/main.tickets')); ?></a>
                                        <a href="/oraclepopupsignin/reports/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="fas fa-info"></i><?php echo e(trans('oraclepopupsignin/main.reports')); ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_clear_cache')): ?>
                                <div class="w-xs-to-lg-100">
                                    ...
                                    <?php echo $__env->make('admin.includes.delete_button',[
                                             'url' => '/oraclepopupsignin/clear-cache',
                                             'btnClass' => 'btn btn-outline-white btn-lg btn-icon icon-left mt-2 w-100',
                                             'btnText' => trans('oraclepopupsignin/main.clear_all_cache'),
                    ...
                    <?php if(!empty($dailySalesTypeStatistics)): ?>
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                <div class="card-stats-title"><?php echo e(trans('oraclepopupsignin/main.daily_sales_type_statistics')); ?></div>

                                <div class="card-stats-items">
                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e($dailySalesTypeStatistics['webinarsSales']); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('oraclepopupsignin/main.live_class')); ?></div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e($dailySalesTypeStatistics['courseSales']); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('oraclepopupsignin/main.course')); ?></div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e($dailySalesTypeStatistics['appointmentSales']); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('oraclepopupsignin/main.appointment')); ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4><?php echo e(trans('oraclepopupsignin/main.today_sales')); ?></h4>
                                </div>
                                <div class="card-body">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_income_statistics')): ?>
                    <?php if(!empty($getIncomeStatistics)): ?>
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                <div class="card-stats-title"><?php echo e(trans('oraclepopupsignin/main.income_statistics')); ?></div>

                                <div class="card-stats-items">
                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatistics['todaySales'])); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('oraclepopupsignin/main.today')); ?></div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatistics['monthSales'])); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('oraclepopupsignin/main.this_month')); ?></div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatistics['yearSales'])); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('oraclepopupsignin/main.this_year')); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-icon shadow-primary bg-primary">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4><?php echo e(trans('oraclepopupsignin/main.total_incomes')); ?></h4>
                                </div>
                                <div class="card-body">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_total_sales_statistics')): ?>
                    <?php if(!empty($getTotalSalesStatistics)): ?>
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                <div class="card-stats-title"><?php echo e(trans('oraclepopupsignin/main.salescount')); ?></div>
        ...
        <div class="row">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_new_sales')): ?>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="/oraclepopupsignin/financial/sales" class="card card-statistic-1">
                        <div class="card-icon bg-primary">
                            <i class="fas fa-shopping-cart"></i>
                        </div>
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4><?php echo e(trans('oraclepopupsignin/main.new_sale')); ?></h4>
                            </div>
                            <div class="card-body">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_new_comments')): ?>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="/oraclepopupsignin/comments/webinars" class="card card-statistic-1">
                        <div class="card-icon bg-danger">
                            <i class="fas fa-comment"></i></div>
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4><?php echo e(trans('oraclepopupsignin/main.new_comment')); ?></h4>
                            </div>
                            <div class="card-body">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_new_tickets')): ?>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="/oraclepopupsignin/supports" class="card card-statistic-1">
                        <div class="card-icon bg-warning">
                            <i class="far fa-envelope"></i></div>
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4><?php echo e(trans('oraclepopupsignin/main.new_ticket')); ?></h4>
                            </div>
                            <div class="card-body">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_new_reviews')): ?>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4><?php echo e(trans('oraclepopupsignin/main.pending_review_classes')); ?></h4>
                            </div>
                            <div class="card-body">
        ...
        <div class="row">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_sales_statistics_chart')): ?>
                <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4><?php echo e(trans('oraclepopupsignin/main.sales_statistics')); ?></h4>
                            <div class="card-header-action">
                                <div class="btn-group">
                                    <button type="button" class="js-sale-chart-month btn"><?php echo e(trans('oraclepopupsignin/main.month')); ?></button>
                                    <button type="button" class="js-sale-chart-year btn btn-primary"><?php echo e(trans('oraclepopupsignin/main.year')); ?></button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php if(!empty($getMonthAndYearSalesChartStatistics)): ?>
                                        <div class="statistic-details mt-4 position-relative">
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-name"><?php echo e(trans('oraclepopupsignin/main.today_sales')); ?></div>
                                            </div>
                                            <div class="statistic-details-item">
                                                <span class="text-muted">
                                                ...
                                                <div class="detail-name"><?php echo e(trans('oraclepopupsignin/main.week_sales')); ?></div>
                                            </div>
                                            <div class="statistic-details-item">
                                                <span class="text-muted">
                                                ...
                                                <div class="detail-name"><?php echo e(trans('oraclepopupsignin/main.month_sales')); ?></div>
                                            </div>
                                            <div class="statistic-details-item">
                                                <span class="text-muted">
                                                ...
                                                <div class="detail-name"><?php echo e(trans('oraclepopupsignin/main.year_sales')); ?></div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_recent_comments')): ?>
                <div class="col-lg-4 col-md-12 col-12 col-sm-12 <?php if(count($recentComments) < 6): ?> pb-30 <?php endif; ?>">
                    <div class="card <?php if(count($recentComments) < 6): ?> h-100 <?php endif; ?>">
                        <div class="card-header">
                            <h4><?php echo e(trans('oraclepopupsignin/main.recent_comments')); ?></h4>
                        </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="text-center pt-1 pb-1">
                                <a href="/oraclepopupsignin/comments/webinars" class="btn btn-primary btn-lg btn-round ">
                                    <?php echo e(trans('oraclepopupsignin/main.view_all')); ?>
                    ...
                    <div class="col-md-4">
                        <div class="card card-hero">
                            <div class="card-header">
                                ...
                                <h5><?php echo e(trans('oraclepopupsignin/main.recent_tickets')); ?></h5>
                                <div class="card-description"><?php echo e($recentTickets['pendingReply']); ?> <?php echo e(trans('oraclepopupsignin/main.pending_reply')); ?></div>
                            </div>
                            ...
                            <div class="card-body p-0">
                                <div class="tickets-list">
                                    ...
                                    <?php $__currentLoopData = $recentTickets['tickets']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="/oraclepopupsignin/supports/<?php echo e($ticket->id); ?>/conversation" class="ticket-item">
                                            ...
                                            <div class="ticket-info">
                                                ...
                                                <?php if($ticket->status == 'open'): ?>
                                                    <span class="text-warning  text-small font-600-bold"><?php echo e(trans('oraclepopupsignin/main.pending_reply')); ?></span>
                                                <?php elseif($ticket->status == 'close'): ?>
                                                    <span class="text-danger  text-small font-600-bold"><?php echo e(trans('oraclepopupsignin/main.close')); ?></span>
                                                <?php elseif($ticket->status == 'replied'): ?>
                                                    <span class="text-warning  text-small font-600-bold"><?php echo e(trans('oraclepopupsignin/main.pending_reply')); ?></span>
                                                <?php else: ?>
                                                    <span class="text-primary  text-small font-600-bold"><?php echo e(trans('oraclepopupsignin/main.replied')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </a>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                    <a href="/oraclepopupsignin/supports" class="ticket-item ticket-more">
                                        <?php echo e(trans('oraclepopupsignin/main.view_all')); ?> <i class="fas fa-chevron-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-hero">
                            <div class="card-header">
                                ...
                                <h5><?php echo e(trans('oraclepopupsignin/main.recent_live_classes')); ?></h5>
                                <div class="card-description"><?php echo e($recentWebinars['pendingReviews']); ?> <?php echo e(trans('oraclepopupsignin/main.pending_review')); ?></div>
                            </div>
                            <div class="card-body p-0">
                                <div class="tickets-list">
                                    <?php $__currentLoopData = $recentWebinars['webinars']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="/oraclepopupsignin/webinars/<?php echo e($webinar->id); ?>/edit" class="ticket-item">
                                            <div class="ticket-title">
                                            ...
                                            <div class="ticket-info">
                                                ...
                                                <?php switch($webinar->status):
                                                    ...
                                                    <span class="text-success"><?php echo e(trans('oraclepopupsignin/main.publish')); ?></span>
                                                    ...
                                                    <?php elseif($webinar->start_date > time()): ?>
                                                        <div class="text-danger text-small font-600-bold">(<?php echo e(trans('oraclepopupsignin/main.not_conducted')); ?>)</div>
                                                    <?php else: ?>
                                    ...
                                    <a href="/oraclepopupsignin/webinars?type=webinar" class="ticket-item ticket-more">
                                        <?php echo e(trans('oraclepopupsignin/main.view_all')); ?> <i class="fas fa-chevron-right"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-hero">
                            <div class="card-header">
                                ...
                                <h5><?php echo e(trans('oraclepopupsignin/main.recent_courses')); ?></h5>
                                <div class="card-description"><?php echo e($recentCourses['pendingReviews']); ?> <?php echo e(trans('oraclepopupsignin/main.pending_review')); ?></div>
                            </div>
                            <div class="card-body p-0">
                                <div class="tickets-list">
                                    ...
                                    <?php $__currentLoopData = $recentCourses['courses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="/oraclepopupsignin/webinars/<?php echo e($course->id); ?>/edit" class="ticket-item">
                                            <div class="ticket-title">
                                    ...
                                    <a href="/oraclepopupsignin/webinars?type=course" class="ticket-item ticket-more">
                                        <?php echo e(trans('oraclepopupsignin/main.view_all')); ?> <i class="fas fa-chevron-right"></i>
                                    </a>
                                </div>
                            </div>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_users_statistics_chart')): ?>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4><?php echo e(trans('oraclepopupsignin/main.new_registration_statistics')); ?></h4>
                            <div class="card-header-action">
                                <div class="btn-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>