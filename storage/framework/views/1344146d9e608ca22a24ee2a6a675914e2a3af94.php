...
<div class="d-none" id="webinarChapterModal">
    ...
    <form action="/oraclepopupsignin/chapters/store" method="post">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            <label class="input-label"><?php echo e(trans('oraclepopupsignin/main.type')); ?></label>
            <select class="custom-select" name="type" required>
                <?php $__currentLoopData = \App\Models\WebinarChapter::$chapterTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapterType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($chapterType); ?>"><?php echo e(trans('oraclepopupsignin/main.'.$chapterType)); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <div class="invalid-feedback"></div>
        </div>
        ...
        <div class="js-chapter-status form-group mt-3">
            <div class="d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="chapterStatusSwitch_record"><?php echo e(trans('oraclepopupsignin/main.active')); ?></label>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/webinars/modals/chapter.blade.php ENDPATH**/ ?>