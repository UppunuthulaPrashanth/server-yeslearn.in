<div class="tab-pane mt-3 fade" id="financial" role="tabpanel" aria-labelledby="financial-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/users/<?php echo e($user->id .'/financialUpdate'); ?>" method="Post">
                ...
                <?php if(!$user->isUser()): ?>
                    <div class="form-group">
                        <label><?php echo e(trans('oraclepopupsignin/main.user_commission')); ?> (%)</label>
                        <input type="text" name="commission"
                               class="form-control "
                               value="<?php echo e(!empty($user) ? $user->commission : old('commission')); ?>"
                               placeholder="<?php echo e(trans('oraclepopupsignin/main.user_commission_placeholder')); ?>"/>
                    </div>
                <?php endif; ?>
                ...
                <div class="form-group mb-0 d-flex">
                    ...
                    <label for="verifySwitch"><?php echo e(trans('oraclepopupsignin/main.financial_approval')); ?></label>
                </div>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/users/editTabs/financial.blade.php ENDPATH**/ ?>