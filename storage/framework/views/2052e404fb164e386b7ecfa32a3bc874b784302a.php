            ...
            <?php if(!empty($authUser)): ?>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu user-profile-dropdown" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="<?php echo e($authUser->isAdmin() ? '/oraclepopupsignin' : '/panel'); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/yeslearn.in/public_html/resources/views/web/default/includes/top_nav.blade.php ENDPATH**/ ?>