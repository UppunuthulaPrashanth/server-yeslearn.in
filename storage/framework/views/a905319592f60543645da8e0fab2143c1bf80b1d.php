<div class="tab-pane mt-3 fade" id="registrationPackage" role="tabpanel" aria-labelledby="registrationPackage-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/users/<?php echo e($user->id); ?>/userRegistrationPackage" method="Post">
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0 d-flex align-items-center">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="packageStatusSwitch"><?php echo e(trans('oraclepopupsignin/main.active')); ?></label>
                    </label>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/users/editTabs/registration_package.blade.php ENDPATH**/ ?>