<div class="tab-pane mt-3 fade" id="occupations" role="tabpanel" aria-labelledby="occupations-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/users/<?php echo e($user->id .'/occupationsUpdate'); ?>" method="Post">
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/users/editTabs/occupations.blade.php ENDPATH**/ ?>