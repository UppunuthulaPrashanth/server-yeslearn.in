...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-0H69V39TKY"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-0H69V39TKY');
</script>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/web/default/panel/layouts/panel_layout.blade.php ENDPATH**/ ?>