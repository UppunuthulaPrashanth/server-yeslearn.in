...
<div class="tab-pane mt-3 fade" id="meetingSettings" role="tabpanel" aria-labelledby="meetingSettings-tab">
    <div class="row">
        <div class="col-12">
            <form action="/oraclepopupsignin/users/<?php echo e($user->id); ?>/meetingSettings" method="Post">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/users/editTabs/meeting_settings.blade.php ENDPATH**/ ?>