<div class="tab-pane mt-3 fade" id="badges" role="tabpanel" aria-labelledby="badges-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/users/<?php echo e($user->id .'/badgesUpdate'); ?>" method="Post">
...
unset($__errorArgs, $__bag); ?>">
                        <option value=""><?php echo e(trans('oraclepopupsignin/main.select_badge')); ?></option>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-12">
            <div class="mt-5">
                <h5><?php echo e(trans('oraclepopupsignin/main.custom_badges')); ?></h5>

                <div class="table-responsive mt-5">
                    <table class="table table-striped table-md">
                        <tr>
                            <th><?php echo e(trans('oraclepopupsignin/main.title')); ?></th>
                            <th><?php echo e(trans('oraclepopupsignin/main.image')); ?></th>
                            <th><?php echo e(trans('oraclepopupsignin/main.condition')); ?></th>
                            <th><?php echo e(trans('oraclepopupsignin/main.description')); ?></th>
                            <th class="text-center"><?php echo e(trans('oraclepopupsignin/main.created_at')); ?></th>
                            <th><?php echo e(trans('oraclepopupsignin/main.actions')); ?></th>
                        </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_edit')): ?>
                                            <?php echo $__env->make('admin.includes.delete_button',['url' => '/oraclepopupsignin/users/'.$user->id.'/deleteBadge/'.$customBadge->id , 'btnClass' => 'btn-sm'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-12">
            <div class="mt-5">
                <h5><?php echo e(trans('oraclepopupsignin/main.auto_badges')); ?></h5>
...
<?php /**PATH /home/yeslearn.in/public_html/resources/views/admin/users/editTabs/badges.blade.php ENDPATH**/ ?>