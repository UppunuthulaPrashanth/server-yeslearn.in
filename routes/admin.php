...
Route::group(['prefix' => 'oraclepopupsignin', 'namespace' => 'Admin', 'middleware' => 'web'], function () {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'settings'], function () {
            ...
            Route::post('/affiliate/add', 'SettingsController@addNewAffliatePlan');
            Route::post('/affiliate/update', 'SettingsController@updateAffliatePlan');
            Route::get('/affiliate/delete/{id}', 'SettingsController@deleteAffliatePlan');
