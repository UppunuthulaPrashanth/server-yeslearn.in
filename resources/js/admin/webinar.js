(function ($) {
    ...
    $('body').on('change', '#categories', function (e) {
        ...
        $.get('/oraclepopupsignin/filters/get-by-category-id/' + category_id, function (result) {
        ...
        Swal.fire({
            ...
            onOpen: () => {
                $('.prerequisites-select2').select2({
                    ...
                    allowClear: true,
                    ajax: {
                        url: '/oraclepopupsignin/webinars/search',
                        dataType: 'json',
                        type: "POST",
                        quietMillis: 50,
    ...
    * */
    ...
    function editTicket($this, locale = null) {
        ...
        $.post('/oraclepopupsignin/tickets/' + ticket_id + '/edit', edit_data, function (result) {
            if (result && result.ticket) {
                ...
                edit_ticket_modal = edit_ticket_modal.replaceAll('/oraclepopupsignin/tickets/store', '/oraclepopupsignin/tickets/' + ticket_id + '/update');
    ...
    * */
    ...
    function editChapter($this, locale = null) {
        ...
        $.post('/oraclepopupsignin/chapters/' + chapter_id + '/edit', edit_data, function (result) {
            if (result && result.chapter) {
                ...
                html = html.replaceAll('/oraclepopupsignin/chapters/store', '/oraclepopupsignin/chapters/' + chapter_id + '/update');
                const nameId = randomString();
                html = html.replaceAll('record', nameId);
    ...
    * */
    ...
    function editSession($this, locale = null) {
        ...
        $.post('/oraclepopupsignin/sessions/' + session_id + '/edit', edit_data, function (result) {
            if (result && result.session) {
                ...
                edit_session_modal = edit_session_modal.replaceAll('/oraclepopupsignin/sessions/store', '/oraclepopupsignin/sessions/' + session_id + '/update');
                const nameId = randomString();
    ...
    * */
    ...
    function editFile($this, locale = null) {
        ...
        $.post('/oraclepopupsignin/files/' + file_id + '/edit', edit_data, function (result) {
    ...
    function createEditFileModal(file) {
        ...
        edit_file_modal += '</div>';
        edit_file_modal = edit_file_modal.replaceAll('/oraclepopupsignin/files/store', '/oraclepopupsignin/files/' + file.id + '/update');
    ...
    function createEditInteractiveFileModal(file) {
        ...
        html += $('#interactiveFileModal').html();
        html += '</div>';
        html = html.replaceAll('/oraclepopupsignin/files/store', '/oraclepopupsignin/files/' + file.id + '/update');
        html = html.replaceAll('str_', '');
        const random = randomString();
    ...
    * */
    $('body').on('click', '.edit-prerequisite', function (e) {
        ...
        $.post('/oraclepopupsignin/prerequisites/' + prerequisite_id + '/edit', edit_data, function (result) {
            if (result && result.prerequisite) {
                ...
                edit_prerequisite_modal = edit_prerequisite_modal.replaceAll('/oraclepopupsignin/prerequisites/store', '/oraclepopupsignin/prerequisites/' + prerequisite_id + '/update');
   ...
   * */
    function editFaq($this, locale = null) {
        ...
        $.post('/oraclepopupsignin/faqs/' + faq_id + '/edit', edit_data, function (result) {
            if (result && result.faq) {
                ...
                edit_faq_modal += '</div>';
                edit_faq_modal = edit_faq_modal.replaceAll('/oraclepopupsignin/faqs/store', '/oraclepopupsignin/faqs/' + faq_id + '/update');
   ...
   * */
    $('body').on('click', '.edit-webinar-quiz', function (e) {
        ...
        $.post('/oraclepopupsignin/webinar-quiz/' + webinar_quiz_id + '/edit', edit_data, function (result) {
            if (result && result.webinarQuiz) {
                ...
                edit_webinar_quiz_modal = edit_webinar_quiz_modal.replaceAll('/oraclepopupsignin/webinar-quiz/store', '/oraclepopupsignin/webinar-quiz/' + webinar_quiz_id + '/update');
    ...
    * */
    function editTextLesson($this, locale = null) {
        ...
        $.post('/oraclepopupsignin/test-lesson/' + id + '/edit', edit_data, function (result) {
            if (result && result.testLesson) {
                ...
                addTextLesson += '</div>';
                addTextLesson = addTextLesson.replaceAll('record', nameId);
                addTextLesson = addTextLesson.replaceAll('/oraclepopupsignin/test-lesson/store', '/oraclepopupsignin/test-lesson/' + id + '/update');
