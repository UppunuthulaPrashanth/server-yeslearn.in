(function ($) {
    ...
    $('body').on('click', '.js-show-join-modal', function (e) {
        ...
        $modal.find('.js-join-btn').attr('href', '/oraclepopupsignin/appointments/' + reserve_id + '/join');
    ...
    $('body').on('click', '.js-send-reminder', function (e) {
        ...
        $.get('/oraclepopupsignin/appointments/' + reserve_id + '/getReminderDetails', function (result) {

            $modal.find('.js-send-reminder-btn').attr('href', '/oraclepopupsignin/appointments/' + reserve_id + '/sendReminder');
