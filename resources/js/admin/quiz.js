(function ($) {
    ...
    $('body').on('click', '.edit_question', function (e) {
        ...
        $.get('/oraclepopupsignin/quizzes-questions/' + question_id + '/edit', function (result) {
    ...
    $('body').on('change', '.js-quiz-question-locale', function (e) {
        ...
        const path = '/oraclepopupsignin/quizzes-questions/' + item_id + '/getQuestionByLocale?locale=' + locale;
