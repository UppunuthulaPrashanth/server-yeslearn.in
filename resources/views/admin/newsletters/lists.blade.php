        ...
        <div class="section-body">
            <div class="row">
                ...
                @can('admin_users_export_excel')
                    <a href="/oraclepopupsignin/newsletters/excel" class="btn btn-primary">{{ trans('oraclepopupsignin/main.export_xls') }}</a>
                @endcan
                <div class="h-10"></div>
            </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_newsletters_delete')
                                                    @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/newsletters/'.$newsletter->id.'/delete' , 'btnClass' => 'btn-sm'])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
