                ...
                <div class="card-header">
                    @can('admin_newsletters_send')
                        <div class="text-right">
                            <a href="/oraclepopupsignin/newsletters/send" class="btn btn-primary">{{ trans('update.send_newsletter') }}</a>
                        </div>
                    @endcan
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped font-14" id="datatable-basic">
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{ trans('oraclepopupsignin/main.title') }}</th>
                                <th class="text-center">{{ trans('oraclepopupsignin/main.description') }}</th>
                            ...
                            @foreach($newsletters as $newsletter)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" data-item-id="{{ $newsletter->id }}" class="js-show-description btn btn-outline-primary">{{ trans('oraclepopupsignin/main.show') }}</button>
