        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/oraclepopupsignin/newsletters/send" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group mt-15">
                                    ...
                                    <textarea id="summernote" name="description" class="summernote form-control @error('description')  is-invalid @enderror" placeholder="{{ trans('oraclepopupsignin/main.description_placeholder') }}">{!! old('description')  !!}</textarea>
                                    @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <button type="submit" class="btn btn-primary mt-3">{{ trans('oraclepopupsignin/main.send') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
