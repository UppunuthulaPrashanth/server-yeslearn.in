...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.quiz_results') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{trans('oraclepopupsignin/main.dashboard')}}</a>
                </div>
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.quiz_results') }}</div>
            </div>
        </div>
                        ...
                        <div class="card-header">
                            @can('admin_quiz_result_export_excel')
                                <div class="text-right">
                                    <a href="/oraclepopupsignin/quizzes/{{ $quiz_id}}/results/excel" class="btn btn-primary">{{ trans('oraclepopupsignin/main.export_xls') }}</a>
                                </div>
                            @endcan
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('oraclepopupsignin/main.quiz_date') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_quizzes_results_delete')
                                                    @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/quizzes/result/'. $result->id.'/delete'])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
