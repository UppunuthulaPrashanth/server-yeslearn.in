        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="/oraclepopupsignin/quizzes/{{ $quiz->id }}/update" id="webinarForm" class="webinar-form">
                                {{ csrf_field() }}
                                <section>
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="">
                                                    ...
                                                    <p>{{ trans('oraclepopupsignin/main.instructor') }}: {{ $creator->full_name }}</p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="quiz-question-card d-flex align-items-center mt-4">
                                                    ...
                                                    <div class="btn-group dropdown table-actions">
                                                        ...
                                                        <div class="dropdown-menu text-left">
                                                            ...
                                                            @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/quizzes-questions/'. $question->id .'/delete', 'btnClass' => 'btn-sm btn-transparent' , 'btnText' => trans('public.delete')])
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
                                ...
                                @endif
                                <div class="mt-5 mb-5">
                                    <button type="submit" class="btn btn-primary">{{ !empty($quiz) ? trans('oraclepopupsignin/main.save_change') : trans('oraclepopupsignin/main.create') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
