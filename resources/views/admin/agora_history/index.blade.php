                ...
                <div class="card-header">
                    @can('admin_agora_history_export')
                        <div class="text-right">
                            <a href="/oraclepopupsignin/agora_history/excel" class="btn btn-primary">{{ trans('oraclepopupsignin/main.export_xls') }}</a>
                        </div>
                    @endcan
                </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped text-center font-14">
                            ...
                            <tr>
                                <th class="text-left">{{ trans('oraclepopupsignin/main.course') }}</th>
                                <th class="text-left">{{ trans('oraclepopupsignin/main.session') }}</th>
                                <th class="text-center">{{ trans('update.session_duration') }}</th>
                                <th class="text-center">{{ trans('oraclepopupsignin/main.start_date') }}</th>
                                <th class="text-center">{{ trans('oraclepopupsignin/main.end_date') }}</th>
