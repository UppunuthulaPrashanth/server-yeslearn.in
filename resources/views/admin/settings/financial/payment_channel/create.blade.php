                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/oraclepopupsignin/settings/payment_channels/{{ (!empty($paymentChannel) ? $paymentChannel->id.'/update':'store') }}" method="post">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0">
                                                ...
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="statusSwitch">{{ trans('oraclepopupsignin/main.active') }}</label>
                                            </label>
                                        </div>
                                ...
                                <button type="submit" class="btn btn-primary mt-4">{{ trans('oraclepopupsignin/main.save_change') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
