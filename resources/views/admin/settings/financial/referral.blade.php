            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="affiliate/delete/{{$plan->id}}"><button class="btn btn-danger btn-sm"><i
                                    ...
                                    <div class="card" style="border: 1px solid lightgrey;">
                                        <div class="row m-1">
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" hidden value="{{$plan->id}}" name="itemID"
                                                        id="itemID">
                                                    <input type="number" class="form-control" value="{{$plan->rank}}"
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="{{$plan->label}}"
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" readonly value="Percentage" name="rank_amount_type" id="rank_amount_type"
                                                    class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="color" class="form-control"
                                                        value="{{$plan->rank_color}}" name="rank_color" id="rank_color"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mt-2">
                                                <label for="icon{{$plan->id}}">icon</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <button type="button"
                                                            class="input-group-text admin-file-manager "
                                                            data-input="icon{{$plan->id}}" data-preview="holder">
                                                            <i class="fa fa-upload"></i>
                                                        </button>
                                                    </div>
                                                    <input type="text" name="icon" id="icon{{$plan->id}}" value="{{ $plan->icon }}"
                                                        class="form-control" required />
                                                    <button type="button" class="input-group-text admin-file-view"
                                                        data-input="icon{{$plan->id}}">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control"
                                                        value="{{$plan->direct_commi}}" name="direct_commi"
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control"
                                                        value="{{$plan->partner_commi}}" name="partner_commi"
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <div class="form-group custom-switches-stacked">
                                                    <label class="custom-switch pl-0 d-flex align-items-center">
                                                        @if($plan->status===1)
                                                        <input type="checkbox" name="value" id="referralStatusSwitch"
                                                            checked="checked" class="custom-switch-input" />
