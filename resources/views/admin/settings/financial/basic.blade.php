        ...
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/settings/main" method="post">
                ...
                <div class="form-group">
                    <label>{{ trans('oraclepopupsignin/main.default_commission') }}</label>
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.default_commission_hint') }}</div>
                </div>


                <div class="form-group">
                    <label>{{ trans('oraclepopupsignin/main.tax') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-percentage"></i>
                ...
                <div class="form-group">
                    <label>{{ trans('oraclepopupsignin/main.minimum_payout_amount') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.minimum_payout_amount_hint') }}</div>
                </div>


                <div class="form-group">
                    <label class="input-label d-block">{{ trans('oraclepopupsignin/main.currency') }}</label>
                    <select name="value[currency]" class="form-control select2" data-placeholder="{{ trans('oraclepopupsignin/main.currency') }}">
                        <option value=""></option>
