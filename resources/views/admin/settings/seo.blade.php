...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.seo_metas') }}</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.seo_metas') }}</div>
            </div>
        </div>
                                ...
                                @foreach(\App\Models\Setting::$pagesSeoMetas as $page)
                                    <li class="nav-item">
                                        <a class="nav-link {{ $loop->iteration == 1 ? 'active' : '' }}"
                                           ...
                                           aria-selected="true">{{ trans('oraclepopupsignin/main.seo_metas_'.$page) }}</a>
                                    </li>
                                @endforeach
                            </ul>
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->iteration == 1 ? 'show active' : '' }}" id="{{ $page }}" role="tabpanel" aria-labelledby="{{ $page }}-tab">
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <form action="/oraclepopupsignin/settings/seo_metas/store" method="post">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="form-group custom-switches-stacked">
                                                        <label class="custom-switch pl-0 d-flex align-items-center">
                                                            <label class="custom-switch-description mb-0 mr-2">{{ trans('oraclepopupsignin/main.no_index') }}</label>
                                                            ...
                                                            <label class="custom-switch-description mb-0 cursor-pointer" for="{{ $page }}Robot">{{ trans('oraclepopupsignin/main.index') }}</label>
                                                        </label>
                                                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{ trans('oraclepopupsignin/main.seo_metas_hint_title_1') }}</div>
                        <div class=" text-small font-600-bold mb-2">{{ trans('oraclepopupsignin/main.seo_metas_hint_description_1') }}</div>
                    </div>
                </div>

                <div class="col-md-6">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{ trans('oraclepopupsignin/main.seo_metas_hint_title_2') }}</div>
                        <div class=" text-small font-600-bold mb-2">{{ trans('oraclepopupsignin/main.seo_metas_hint_description_2') }}</div>
                    </div>
                </div>
