...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.custom_css_js') }}</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.custom_css_js') }}</div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="css-tab" data-toggle="tab" href="#css" role="tab" aria-controls="css" aria-selected="true">{{ trans('oraclepopupsignin/main.css') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="js-tab" data-toggle="tab" href="#js" role="tab" aria-controls="js" aria-selected="true">{{ trans('oraclepopupsignin/main.js') }}</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane mt-3 fade active show" id="css" role="tabpanel" aria-labelledby="css-tab">
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <form action="/oraclepopupsignin/settings/custom_css_js/store" method="post">
                                                {{ csrf_field() }}
