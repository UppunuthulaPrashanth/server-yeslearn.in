        ...
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/settings/main" method="post">
                ...
                <div class="form-group">
                    <label>{{ trans('oraclepopupsignin/main.site_name') }}</label>
                ...
                <div class="form-group">
                    <label>{{ trans('oraclepopupsignin/main.site_email') }}</label>
                ...
                <div class="form-group">
                    <label>{{ trans('oraclepopupsignin/main.site_phone') }}</label>
                ...
                <div class="form-group">
                    <label class="input-label d-block">{{ trans('oraclepopupsignin/main.site_language') }}</label>
                    <select name="value[site_language]" class="form-control select2" data-placeholder="{{ trans('oraclepopupsignin/main.site_language') }}">
                        <option value=""></option>
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.default_language_hint') }}</div>
                </div>

                <div class="form-group">
                    <label class="input-label d-block">{{ trans('oraclepopupsignin/main.register_method') }}</label>
                    <select name="value[register_method]" class="form-control">
                        <option value="mobile" @if(!empty($itemValue) and !empty($itemValue['register_method']) and $itemValue['register_method'] == 'mobile') selected @endif>{{ trans('oraclepopupsignin/main.sms') }}</option>
                        <option value="email" @if(!empty($itemValue) and !empty($itemValue['register_method']) and $itemValue['register_method'] == 'email') selected @endif>{{ trans('oraclepopupsignin/main.email') }}</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="value[default_time_zone]" class="form-control select2">
                        <option value="" disabled @if(empty($itemValue) or empty($itemValue['default_time_zone'])) selected @endif>{{ trans('oraclepopupsignin/main.select') }}</option>
                ...
                <div class="form-group">
                    <label class="input-label d-block">{{ trans('oraclepopupsignin/main.user_languages_lists') }}</label>
                    <select name="value[user_languages][]" multiple class="form-control select2" data-placeholder="{{ trans('oraclepopupsignin/main.user_languages_lists') }}">
                        <option value=""></option>
                        @foreach(getLanguages() as $key => $language)
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.user_languages_lists_hint') }}</div>
                </div>


                <div class="form-group">
                    <label class="input-label d-block">{{ trans('oraclepopupsignin/main.rtl_languages') }}</label>
                    <select name="value[rtl_languages][]" multiple class="form-control select2" data-placeholder="{{ trans('oraclepopupsignin/main.rtl_languages') }}">
                        <option value=""></option>
                        @foreach(getLanguages() as $key => $language)
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.rtl_languages_hint') }}</div>
                </div>

                <div class="form-group">
                    <label class="input-label">{{ trans('oraclepopupsignin/main.fav_icon') }}</label>
                    <div class="input-group">
                        ...
                        <input type="text" name="value[fav_icon]" id="fav_icon" value="{{ (!empty($itemValue) and !empty($itemValue['fav_icon'])) ? $itemValue['fav_icon'] : old('fav_icon') }}" class="form-control" placeholder="{{ trans('oraclepopupsignin/main.fav_icon_placeholder') }}"/>
                    </div>
                </div>

                <div class="form-group">
                    <label class="input-label">{{ trans('oraclepopupsignin/main.logo') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" name="value[logo]" id="logo" value="{{ (!empty($itemValue) and !empty($itemValue['logo'])) ? $itemValue['logo'] : old('logo') }}" class="form-control" placeholder="{{ trans('oraclepopupsignin/main.logo_placeholder') }}"/>
                    </div>
                </div>

                <div class="form-group">
                    <label class="input-label">{{ trans('oraclepopupsignin/main.footer_logo') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" name="value[footer_logo]" id="footer_logo" value="{{ (!empty($itemValue) and !empty($itemValue['footer_logo'])) ? $itemValue['footer_logo'] : old('footer_logo') }}" class="form-control" placeholder="{{ trans('oraclepopupsignin/main.footer_logo_placeholder') }}"/>
                    </div>
                </div>

                <div class="form-group">
                    <label class="input-label">{{ trans('oraclepopupsignin/main.webinar_reminder_schedule') }}</label>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="rtlSwitch">{{ trans('oraclepopupsignin/main.rtl_layout') }}</label>
                    </label>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="preloadingSwitch">{{ trans('oraclepopupsignin/main.preloading') }}</label>
                    </label>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="heroSection1">{{ trans('oraclepopupsignin/main.main_home_hero') }}</label>
                    </label>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="heroSection2">{{ trans('oraclepopupsignin/main.main_home_hero2') }}</label>
                    </label>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="contentTranslate">{{ trans('oraclepopupsignin/main.multi_language_content') }}</label>
                    </label>
