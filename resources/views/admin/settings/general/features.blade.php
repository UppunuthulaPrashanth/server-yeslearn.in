...
<div class="tab-pane mt-3 fade" id="features" role="tabpanel" aria-labelledby="features-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/settings/features" method="post">
                {{ csrf_field() }}
                <input type="hidden" name="page" value="general">
                <input type="hidden" name="features" value="features">

                <div class="mb-5">
                    <h5>{{ trans('update.agora') }} {{ trans('oraclepopupsignin/main.settings') }}</h5>

                    <div class="form-group">
                        <label>{{ trans('update.agora') }} {{ trans('update.resolution') }}</label>

                        <select class="form-control" name="value[agora_resolution]">
                            <option value="">{{ trans('oraclepopupsignin/main.select') }} {{ trans('update.resolution') }}</option>
...
--}}
                ...
                <div class="mb-5">
                    <h5>{{ trans('update.new_interactive_file') }} {{ trans('oraclepopupsignin/main.settings') }}</h5>
                ...
                <div class="mb-5">
                    <h5>{{ trans('update.timezone') }} {{ trans('oraclepopupsignin/main.settings') }}</h5>
