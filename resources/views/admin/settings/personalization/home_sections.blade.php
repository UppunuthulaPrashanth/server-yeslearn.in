        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/oraclepopupsignin/settings/home_sections" method="post">
                        {{ csrf_field() }}
                                    ...
                                    @foreach($sections as $section)
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0">
                                                ...
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="{{ $section }}Switch">{{ trans('oraclepopupsignin/main.'.$section) }}</label>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
