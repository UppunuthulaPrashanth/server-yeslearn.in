    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/settings/main" method="post">
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('oraclepopupsignin/main.hero_background') }}</label>
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('oraclepopupsignin/main.hero_vector') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="hasLottie">{{ trans('oraclepopupsignin/main.has_lottie') }}</label>
                    </label>
                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.has_lottie_hint') }}</div>
