    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <h2 class="section-title ml-4">{{ !empty($testimonial) ? trans('oraclepopupsignin/main.edit') : trans('oraclepopupsignin/main.create') }}</h2>

                        <div class="card-body">
                            <form action="/oraclepopupsignin/testimonials/{{ !empty($testimonial) ? $testimonial->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group mt-15">
                                            <label class="input-label">{{ trans('oraclepopupsignin/main.user_avatar') }}</label>
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="user_avatar" id="user_avatar" value="{{ !empty($testimonial->user_avatar) ? $testimonial->user_avatar : old('user_avatar') }}" class="form-control @error('user_avatar') is-invalid @enderror" placeholder="{{ trans('oraclepopupsignin/main.testimonial_user_avatar_placeholder') }}"/>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('oraclepopupsignin/main.user_name') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('oraclepopupsignin/main.user_bio') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('oraclepopupsignin/main.rate') }}</label>
                                            <input type="number" name="rate" class="form-control  @error('rate') is-invalid @enderror"
                                                   value="{{ !empty($testimonial) ? $testimonial->rate : old('rate') }}" placeholder="{{ trans('oraclepopupsignin/main.testimonial_rate_placeholder') }}"/>
                                            @error('rate')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group mt-15">
                                    <label class="input-label">{{ trans('oraclepopupsignin/main.comment') }}</label>
                                ...
                                <div class="form-group custom-switches-stacked">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="testimonialStatus">{{ trans('oraclepopupsignin/main.active') }}</label>
                                    </label>
                                </div>
