            ...
            <div class="col-12 mb-4">
                <div class="hero text-white hero-bg-image hero-bg" data-background="{{ !empty(getPageBackgroundSettings('admin_dashboard')) ? getPageBackgroundSettings('admin_dashboard') : '' }}">
                    <div class="hero-inner">
                        <h2>{{trans('oraclepopupsignin/main.welcome')}}, {{ $authUser->full_name }}!</h2>

                        <div class="d-flex flex-column flex-lg-row align-items-center justify-content-between">
                            @can('admin_general_dashboard_quick_access_links')
                                <div>
                                    <p class="lead">{{trans('oraclepopupsignin/main.welcome_card_text')}}</p>

                                    <div class="mt-2 mb-2 d-flex flex-column flex-md-row">
                                        <a href="/oraclepopupsignin/comments/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="far fa-comment"></i>{{trans('oraclepopupsignin/main.comments')}} </a>
                                        <a href="/oraclepopupsignin/supports" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="far fa-envelope"></i>{{trans('oraclepopupsignin/main.tickets')}}</a>
                                        <a href="/oraclepopupsignin/reports/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="fas fa-info"></i>{{trans('oraclepopupsignin/main.reports')}}</a>
                                    </div>
                                </div>
                            @endcan
                    ...
                    @if(!empty($dailySalesTypeStatistics))
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                <div class="card-stats-title">{{trans('oraclepopupsignin/main.daily_sales_type_statistics')}}</div>

                                <div class="card-stats-items">
                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count">{{ $dailySalesTypeStatistics['webinarsSales'] }}</div>
                                        <div class="card-stats-item-label">{{trans('oraclepopupsignin/main.live_class')}}</div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count">{{ $dailySalesTypeStatistics['courseSales'] }}</div>
                                        <div class="card-stats-item-label">{{trans('oraclepopupsignin/main.course')}}</div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count">{{ $dailySalesTypeStatistics['appointmentSales'] }}</div>
                                        <div class="card-stats-item-label">{{trans('oraclepopupsignin/main.appointment')}}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4>{{trans('oraclepopupsignin/main.today_sales')}}</h4>
                                </div>
                                <div class="card-body">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                @can('admin_general_dashboard_income_statistics')
                    @if(!empty($getIncomeStatistics))
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                <div class="card-stats-title">{{trans('oraclepopupsignin/main.income_statistics')}}</div>

                                <div class="card-stats-items">
                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count">{{ addCurrencyToPrice($getIncomeStatistics['todaySales']) }}</div>
                                        <div class="card-stats-item-label">{{trans('oraclepopupsignin/main.today')}}</div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count">{{ addCurrencyToPrice($getIncomeStatistics['monthSales']) }}</div>
                                        <div class="card-stats-item-label">{{trans('oraclepopupsignin/main.this_month')}}</div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count">{{ addCurrencyToPrice($getIncomeStatistics['yearSales']) }}</div>
                                        <div class="card-stats-item-label">{{trans('oraclepopupsignin/main.this_year')}}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-icon shadow-primary bg-primary">
                            ...
                            <div class="card-wrap">
                                <div class="card-header">
                                    <h4>{{trans('oraclepopupsignin/main.total_incomes')}}</h4>
                                </div>
                                <div class="card-body">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                @can('admin_general_dashboard_total_sales_statistics')
                    @if(!empty($getTotalSalesStatistics))
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                <div class="card-stats-title">{{trans('oraclepopupsignin/main.salescount')}}</div>
            ...
            @can('admin_general_dashboard_new_sales')
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="/oraclepopupsignin/financial/sales" class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('oraclepopupsignin/main.new_sale')}}</h4>
                            </div>
                            <div class="card-body">
                                {{ $getNewSalesCount }}
                            </div>
            ...
            @can('admin_general_dashboard_new_comments')
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="/oraclepopupsignin/comments/webinars" class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('oraclepopupsignin/main.new_comment')}}</h4>
                            </div>
                            <div class="card-body">
                                {{ $getNewCommentsCount }}
                            </div>
            ...
            @can('admin_general_dashboard_new_tickets')
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="/oraclepopupsignin/supports" class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('oraclepopupsignin/main.new_ticket')}}</h4>
                            </div>
                            <div class="card-body">
                                {{ $getNewTicketsCount }}
                            </div>
            ...
            @can('admin_general_dashboard_new_reviews')
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('oraclepopupsignin/main.pending_review_classes')}}</h4>
                            </div>
                            <div class="card-body">
        ...
        <div class="row">
            @can('admin_general_dashboard_sales_statistics_chart')
                <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.sales_statistics')}}</h4>
                            <div class="card-header-action">
                                <div class="btn-group">
                                    <button type="button" class="js-sale-chart-month btn">{{trans('oraclepopupsignin/main.month')}}</button>
                                    <button type="button" class="js-sale-chart-year btn btn-primary">{{trans('oraclepopupsignin/main.year')}}</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    @if(!empty($getMonthAndYearSalesChartStatistics))
                                        <div class="statistic-details mt-4 position-relative">
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-name">{{trans('oraclepopupsignin/main.today_sales')}}</div>
                                            </div>
                                            <div class="statistic-details-item">
                                                <span class="text-muted">
                                                ...
                                                <div class="detail-name">{{trans('oraclepopupsignin/main.week_sales')}}</div>
                                            </div>
                                            <div class="statistic-details-item">
                                                <span class="text-muted">
                                                ...
                                                <div class="detail-name">{{trans('oraclepopupsignin/main.month_sales')}}</div>
                                            </div>
                                            <div class="statistic-details-item">
                                                <span class="text-muted">
                                                ...
                                                <div class="detail-name">{{trans('oraclepopupsignin/main.year_sales')}}</div>
                                            </div>
                                        </div>
                                    @endif
                                </div>
            ...
            @can('admin_general_dashboard_recent_comments')
                <div class="col-lg-4 col-md-12 col-12 col-sm-12 @if(count($recentComments) < 6) pb-30 @endif">
                    <div class="card @if(count($recentComments) < 6) h-100 @endif">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.recent_comments')}}</h4>
                        </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="text-center pt-1 pb-1">
                                <a href="/oraclepopupsignin/comments/webinars" class="btn btn-primary btn-lg btn-round ">
                                    {{trans('oraclepopupsignin/main.view_all')}}
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-hero">
                            <div class="card-header">
                                ...
                                <h5>{{trans('oraclepopupsignin/main.recent_tickets')}}</h5>
                                <div class="card-description">{{ $recentTickets['pendingReply'] }} {{ trans('oraclepopupsignin/main.pending_reply') }}</div>
                            </div>
                            ...
                            <div class="card-body p-0">
                                <div class="tickets-list">
                                    ...
                                    @foreach($recentTickets['tickets'] as $ticket)
                                        <a href="/oraclepopupsignin/supports/{{ $ticket->id }}/conversation" class="ticket-item">
                                            ...
                                            <div class="ticket-info">
                                                ...
                                                @if($ticket->status == 'open')
                                                    <span class="text-warning  text-small font-600-bold">{{ trans('oraclepopupsignin/main.pending_reply') }}</span>
                                                @elseif($ticket->status == 'close')
                                                    <span class="text-danger  text-small font-600-bold">{{ trans('oraclepopupsignin/main.close') }}</span>
                                                @elseif($ticket->status == 'replied')
                                                    <span class="text-warning  text-small font-600-bold">{{ trans('oraclepopupsignin/main.pending_reply') }}</span>
                                                @else
                                                    <span class="text-primary  text-small font-600-bold">{{ trans('oraclepopupsignin/main.replied') }}</span>
                                                @endif
                                            </div>
                                        </a>
                                    @endforeach
                                    ...
                                    <a href="/oraclepopupsignin/supports" class="ticket-item ticket-more">
                                        {{trans('oraclepopupsignin/main.view_all')}} <i class="fas fa-chevron-right"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-hero">
                            <div class="card-header">
                                ...
                                <h5>{{trans('oraclepopupsignin/main.recent_live_classes')}}</h5>
                                <div class="card-description">{{ $recentWebinars['pendingReviews'] }} {{trans('oraclepopupsignin/main.pending_review')}}</div>
                            </div>
                            <div class="card-body p-0">
                                <div class="tickets-list">
                                    @foreach($recentWebinars['webinars'] as $webinar)
                                        <a href="/oraclepopupsignin/webinars/{{ $webinar->id }}/edit" class="ticket-item">
                                            <div class="ticket-title">
                                                <h4>{{ $webinar->title }}</h4>
                                            </div>
                                            ...
                                            <div class="ticket-info">
                                                ...
                                                @switch($webinar->status)
                                                    ...
                                                    <span class="text-success">{{ trans('oraclepopupsignin/main.publish') }}</span>
                                                    ...
                                                    @elseif($webinar->start_date > time())
                                                        <div class="text-danger text-small font-600-bold">({{  trans('oraclepopupsignin/main.not_conducted') }})</div>
                                                    @else
                    ...
                    <div class="col-md-4">
                        <div class="card card-hero">
                            <div class="card-header">
                                ...
                                <h5>{{trans('oraclepopupsignin/main.recent_courses')}}</h5>
                                <div class="card-description">{{ $recentCourses['pendingReviews'] }} {{trans('oraclepopupsignin/main.pending_review')}}</div>
                            </div>
                            <div class="card-body p-0">
                                <div class="tickets-list">
                                    ...
                                    @foreach($recentCourses['courses'] as $course)
                                        <a href="/oraclepopupsignin/webinars/{{ $course->id }}/edit" class="ticket-item">
                                            <div class="ticket-title">
                                                <h4>{{ $course->title }}</h4>
                                            </div>
        ...
        @can('admin_general_dashboard_users_statistics_chart')
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.new_registration_statistics')}}</h4>
                            <div class="card-header-action">
                                <div class="btn-group">
