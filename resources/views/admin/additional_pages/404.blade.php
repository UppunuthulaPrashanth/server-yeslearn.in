...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.404_page_setting') }}</h1>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/oraclepopupsignin/additional_page/404" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('oraclepopupsignin/main.error_404_image') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('oraclepopupsignin/main.error_404_title') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label class="input-label">{{ trans('oraclepopupsignin/main.error_404_description') }}</label>
