    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.conversation') }}</div>
            </div>
        </div>
                                    ...
                                    <div class="chat-details">
                                        ...
                                        <div class="chat-time">
                                            ...
                                            @if(!empty($conversations->attach))
                                                <a href="{{ url($conversations->attach) }}" target="_blank" class="text-success"><i class="fa fa-paperclip"></i> {{ trans('oraclepopupsignin/main.open_attach') }}</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-12 ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/oraclepopupsignin/supports/{{ $support->id }}/conversation" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 text-right mt-4">
                                        ...
                                        @if($support->status != 'close')
                                            <a href="/oraclepopupsignin/supports/{{ $support->id }}/close" class="btn btn-danger ml-1">{{ trans('oraclepopupsignin/main.close_conversation') }}</a>
                                        @endif
                                    </div>
                                </div>
                            </form>
