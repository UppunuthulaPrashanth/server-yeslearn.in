...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.supports') }}</h1>
        ...
        <div class="row">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.total_conversations')}}</h4>
                        </div>
                        <div class="card-body">
                            {{ $totalConversations }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.pending_reply')}}</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.open_conversations')}}</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.closed_conversations')}}</h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="card-body">
                    <form method="get" class="mb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="input-label">{{trans('oraclepopupsignin/main.department')}}</label>
                                    <select name="department_id" data-plugin-selectTwo class="form-control populate">
                                        <option value="">{{trans('oraclepopupsignin/main.all_departments')}}</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="role_id" data-plugin-selectTwo class="form-control populate">
                                        <option value="">{{trans('oraclepopupsignin/main.all_user_roles')}}</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="open" @if(request()->get('status') == 'open') selected @endif>{{trans('oraclepopupsignin/main.open')}}</option>
                                        <option value="replied" @if(request()->get('status') == 'replied') selected @endif>{{trans('oraclepopupsignin/main.pending_reply')}}</option>
                                        <option value="supporter_replied" @if(request()->get('status') == 'supporter_replied') selected @endif>{{trans('oraclepopupsignin/main.replied')}}</option>
                                        <option value="close" @if(request()->get('status') == 'close') selected @endif>{{trans('oraclepopupsignin/main.closed')}}</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive text-center">
                        <table class="table table-striped font-14">
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{trans('oraclepopupsignin/main.created_date')}}</th>
                                <th class="text-center">{{trans('oraclepopupsignin/main.last_update')}}</th>
                                <th class="text-left">{{trans('oraclepopupsignin/main.user')}}</th>
                                <th class="text-center">{{trans('oraclepopupsignin/main.role')}}</th>
                                <th class="text-center">{{trans('oraclepopupsignin/main.department')}}</th>
                            ...
                            @foreach($supports as $support)
                                <tr>
                                    <td>
                                        <a href="/oraclepopupsignin/supports/{{ $support->id }}/conversation">
                                            {{ $support->title }}
                                        </a>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        @if($support->status == 'close')
                                            <span class="text-danger">{{ trans('oraclepopupsignin/main.close') }}</span>
                                        @elseif($support->status == 'replied' or $support->status == 'open')
                                            <span class="text-warning">{{trans('oraclepopupsignin/main.pending_reply')}}</span>
                                        @else
                                            <span class="text-primary">{{trans('oraclepopupsignin/main.replied')}}</span>
                                        @endif
                                    </td>

                                    <td class="text-center" width="50">
                                        @can('admin_supports_reply')
                                            <a href="/oraclepopupsignin/supports/{{ $support->id }}/conversation" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.reply') }}">
                                                <i class="fa fa-reply" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('admin_supports_delete')
                                            @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/supports/'.$support->id.'/delete' , 'btnClass' => 'btn-sm'])
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
