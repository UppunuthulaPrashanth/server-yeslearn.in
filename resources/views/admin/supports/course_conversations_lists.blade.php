        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.classes_with_support')}}</h4>
                        </div>
                        <div class="card-body">
                            {{ $classesWithSupport }}
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        <th>{{trans('oraclepopupsignin/main.subject')}}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($support->status == 'close')
                                                    <span class="text-warning">{{ trans('oraclepopupsignin/main.close') }}</span>
                                                @else
                                                    <span class="text-success">{{ trans('oraclepopupsignin/main.open') }}</span>
                                                @endif
                                            </td>

                                            <td class="text-center" width="50">
                                                @can('admin_supports_reply')
                                                    <a href="/oraclepopupsignin/supports/{{ $support->id }}/conversation" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.conversation') }}">
                                                        <i class="fa fa-reply" aria-hidden="true"></i>
                                                    </a>
                                                @endcan

                                                @can('admin_supports_delete')
                                                    @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/supports/'.$support->id.'/delete' , 'btnClass' => ''])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
