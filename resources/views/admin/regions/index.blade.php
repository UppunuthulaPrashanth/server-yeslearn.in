                ...
                <div class="card-header">
                    ...
                    @can('admin_regions_create')
                        <div class="text-right">
                            <a href="/oraclepopupsignin/regions/new?type={{ $type }}" class="btn btn-primary">{{ trans('oraclepopupsignin/main.new') }}</a>
                        </div>
                    @endcan
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('admin_regions_edit')
                                            <a href="/oraclepopupsignin/regions/{{ $region->id }}/edit" class="btn-transparent text-primary mr-2">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                        @endcan

                                        @can('admin_regions_delete')
                                            @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/regions/'.$region->id.'/delete'])
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
