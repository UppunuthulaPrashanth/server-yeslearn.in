                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-8 col-lg-6">
                            <form action="/oraclepopupsignin/advertising/banners/{{ !empty($banner) ? $banner->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label>{{ trans('oraclepopupsignin/main.position') }}</label>
                                    <select name="position" class="form-control @error('position') is-invalid @enderror">
                                        <option selected disabled>{{ trans('oraclepopupsignin/main.position') }}</option>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('oraclepopupsignin/main.banner_size') }}</label>
                                    <select name="size" class="form-control @error('size') is-invalid @enderror">
                                        <option selected disabled>{{ trans('oraclepopupsignin/main.banner_size') }}</option>
                                ...
                                <div class="form-group custom-switches-stacked">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="published">{{ trans('oraclepopupsignin/main.published') }}</label>
                                    </label>
                                </div>
