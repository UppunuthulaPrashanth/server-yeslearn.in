                    ...
                    <div class="card">
                        <div class="card-header">
                            @can('admin_advertising_banners_create')
                                <a href="/oraclepopupsignin/advertising/banners/new" class="btn btn-primary">{{ trans('oraclepopupsignin/main.new_banner') }}</a>
                            @endcan
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('oraclepopupsignin/main.position') }}</th>
                                        <th class="text-center">{{ trans('oraclepopupsignin/main.banner_size') }}</th>
                                        <th class="text-center">{{ trans('oraclepopupsignin/main.published') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('admin_advertising_banners_edit')
                                                    <a href="/oraclepopupsignin/advertising/banners/{{ $banner->id }}/edit" class="btn-sm btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endcan

                                                @can('admin_advertising_banners_delete')
                                                    @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/advertising/banners/'. $banner->id.'/delete','btnClass' => ''])
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
