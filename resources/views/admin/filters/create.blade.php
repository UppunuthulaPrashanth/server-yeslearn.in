...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{!empty($filter) ?trans('/oraclepopupsignin/main.edit'): trans('oraclepopupsignin/main.new') }} {{ trans('oraclepopupsignin/main.filters') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{ trans('oraclepopupsignin/main.dashboard') }}</a>
                </div>
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/filters">{{ trans('oraclepopupsignin/main.filters') }}</a>
                </div>
                <div class="breadcrumb-item">{{!empty($filter) ?trans('/oraclepopupsignin/main.edit'): trans('oraclepopupsignin/main.new') }}</div>
            </div>
        </div>
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="/oraclepopupsignin/filters/{{ !empty($filter) ? $filter->id.'/update' : 'store' }}"
                                  method="Post">
                                {{ csrf_field() }}
                                ...
                                <div id="filterOptions" class="ml-1">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <strong class="d-block">{{ trans('oraclepopupsignin/main.add_options') }}</strong>

                                        <button type="button" class="btn btn-success add-btn "><i class="fa fa-plus"></i> {{ trans('oraclepopupsignin/main.add') }}</button>
                                    </div>
