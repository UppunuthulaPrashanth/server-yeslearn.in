    ...
    <form action="/oraclepopupsignin/sessions/store" method="post" class="session-form">
        ...
        <div class="form-group">
            ...
            <div class="js-zoom-not-complete-alert mt-10 text-danger d-none">
                {{ trans('oraclepopupsignin/main.teacher_zoom_jwt_token_invalid') }}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="custom-select" name="chapter_id">
                <option value="">{{ trans('oraclepopupsignin/main.no_chapter') }}</option>
        ...
        <div class="js-session-status form-group mt-3">
            <div class="d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="sessionStatusSwitch_record">{{ trans('oraclepopupsignin/main.active') }}</label>
