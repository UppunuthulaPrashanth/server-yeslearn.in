...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{!empty($webinar) ?trans('/oraclepopupsignin/main.edit'): trans('oraclepopupsignin/main.new') }} {{ trans('oraclepopupsignin/main.class') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{ trans('oraclepopupsignin/main.dashboard') }}</a>
                </div>
                <div class="breadcrumb-item active">
                    <a href="/oraclepopupsignin/webinars">{{ trans('oraclepopupsignin/main.classes') }}</a>
                </div>
                <div class="breadcrumb-item">{{!empty($webinar) ?trans('/oraclepopupsignin/main.edit'): trans('oraclepopupsignin/main.new') }}</div>
            </div>
        </div>
                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="/oraclepopupsignin/webinars/{{ !empty($webinar) ? $webinar->id.'/update' : 'store' }}" id="webinarForm" class="webinar-form">
                                {{ csrf_field() }}
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15">
                                                <label class="input-label">{{ trans('oraclepopupsignin/main.class_url') }}</label>
                                                ...
                                                <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.class_url_hint') }}</div>
                                                @error('slug')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            @if(!empty($webinar) and $webinar->creator->isOrganization())
                                                <div class="form-group mt-15 ">
                                                    <label class="input-label d-block">{{ trans('oraclepopupsignin/main.organization') }}</label>
                                            ...
                                            <div class="form-group mt-15 ">
                                                <label class="input-label d-block">{{ trans('oraclepopupsignin/main.select_a_instructor') }}</label>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.seo_description_hint') }}</div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div id="partnerInstructorInput" class="form-group mt-15 {{ !empty($webinar) && $webinar->partner_instructor ? '' : 'd-none' }}">
                                                ...
                                                <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.select_a_partner_hint') }}</div>
                                            </div>

                                            <div class="form-group mt-15">
                                                <label class="input-label d-block">{{ trans('public.tags') }}</label>
                                                <input type="text" name="tags" data-max-tag="5" value="{{ !empty($webinar) ? implode(',',$webinarTags) : '' }}" class="form-control inputtags" placeholder="{{ trans('public.type_tag_name_and_press_enter') }} ({{ trans('oraclepopupsignin/main.max') }} : 5)"/>
                                            </div>
                                ...
                                @if(!empty($webinar))
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h2 class="section-title after-line">{{ trans('oraclepopupsignin/main.price_plans') }}</h2>
                                            <button id="webinarAddTicket" type="button" class="btn btn-primary btn-sm mt-3">{{ trans('oraclepopupsignin/main.add_price_plan') }}</button>
                                        </div>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($tickets as $ticket)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" data-ticket-id="{{ $ticket->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-ticket btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/tickets/'. $ticket->id .'/delete', 'btnClass' => ' mt-1'])
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($chapters as $chapter)
                                                                <tr>
                                                                    <th>{{ $chapter->title }}</th>
                                                                    <th>{{ trans('oraclepopupsignin/main.'.$chapter->type) }}</th>
                                                                    <th>{{ $chapter->getTopicsCount() }}</th>
                                                                    <th>{{ trans('oraclepopupsignin/main.'.$chapter->status) }}</th>

                                                                    <td class="text-right">
                                                                        <button type="button" data-chapter-id="{{ $chapter->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-chapter btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/chapters/'. $chapter->id .'/delete', 'btnClass' => ' mt-1'])
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                    ...
                                                    @if(!empty($sessions) and !$sessions->isEmpty())
                                                        <div class="table-responsive">
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                <tr>
                                                                    <th>{{ trans('public.title') }}</th>
                                                                    <th>{{ trans('oraclepopupsignin/main.session_api') }}</th>
                                                                ...
                                                                @foreach($sessions as $session)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $session->duration }} {{ trans('oraclepopupsignin/main.min') }}</td>
                                                                        <td>{{ $session->getJoinLink() }}</td>
                                                                        <th>{{ trans('oraclepopupsignin/main.'.$session->status) }}</th>
                                                                        <td>
                                                                            <button type="button" data-session-id="{{ $session->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-session btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>

                                                                            @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/sessions/'. $session->id .'/delete', 'btnClass' => ' mt-1'])
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($files as $file)
                                                                <tr>
                                                                    ...
                                                                    <th>{{ trans('oraclepopupsignin/main.'.$file->status) }}</th>
                                                                    <td>
                                                                        <button type="button" data-file-id="{{ $file->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-file btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/files/'. $file->id .'/delete', 'btnClass' => ' mt-1'])
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            @if(count($textLesson->attachments) > 0)
                                                                                <span class="text-success">{{ trans('oraclepopupsignin/main.yes') }} ({{ count($textLesson->attachments) }})</span>
                                                                            @else
                                                                                <span class="text-dark">{{ trans('oraclepopupsignin/main.no') }}</span>
                                                                            @endif
                                                                        </td>
                                                                        <td>{{ $textLesson->accessibility }}</td>
                                                                        <th>{{ trans('oraclepopupsignin/main.'.$textLesson->status) }}</th>
                                                                        <td>
                                                                            <button type="button" data-text-id="{{ $textLesson->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-test-lesson btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>

                                                                            @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/test-lesson/'. $textLesson->id .'/delete', 'btnClass' => ' mt-1'])
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                            ...
                                                            @foreach($prerequisites as $prerequisite)
                                                                @if(!empty($prerequisite->prerequisiteWebinar->title))
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button" data-prerequisite-id="{{ $prerequisite->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-prerequisite btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>

                                                                            @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/prerequisites/'. $prerequisite->id .'/delete', 'btnClass' => ' mt-1'])
                                                                        </td>
                                                                    </tr>
                                                                @endif
                                                            @endforeach
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($faqs as $faq)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <button type="button" data-faq-id="{{ $faq->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-faq btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/faqs/'. $faq->id .'/delete', 'btnClass' => ' mt-1'])
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($webinarQuizzes as $webinarQuiz)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" data-webinar-quiz-id="{{ $webinarQuiz->id }}" data-webinar-id="{{ !empty($webinar) ? $webinar->id : '' }}" class="edit-webinar-quiz btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('oraclepopupsignin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/webinar-quiz/'. $webinarQuiz->id .'/delete', 'btnClass' => ' mt-1'])
                                                                    </td>
                                                                    @endforeach
                                                                </tr>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish" class="btn btn-success">{{ !empty($webinar) ? trans('oraclepopupsignin/main.save_and_publish') : trans('oraclepopupsignin/main.save_and_continue') }}</button>
...
@push('scripts_bottom')
    <script>
        ...
        var zoomJwtTokenInvalid = '{{ trans('oraclepopupsignin/main.teacher_zoom_jwt_token_invalid') }}';
