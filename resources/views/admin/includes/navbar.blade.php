    ...
    <li class="dropdown dropdown-list-toggle">
        ...
        @can('admin_notifications_list')
            <li class="dropdown dropdown-list-toggle">
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right">
                    <div class="dropdown-header">{{ trans('oraclepopupsignin/main.notifications') }}
                        <div class="float-right">
                            @can('admin_notifications_markAllRead')
                                <a href="/oraclepopupsignin/notifications/mark_all_read">{{ trans('oraclepopupsignin/main.mark_all_read') }}</a>
                            @endcan
                        </div>
                    </div>
                    ...
                    <div class="dropdown-footer text-center">
                        <a href="/oraclepopupsignin/notifications">{{ trans('oraclepopupsignin/main.view_all') }} <i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
            </li>
        @endcan
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                 ...
                 <a href="/" class="dropdown-item has-icon">
                    <i class="fas fa-globe"></i> {{ trans('oraclepopupsignin/main.show_website') }}
                </a>

                <a href="/oraclepopupsignin/users/{{ $authUser->id }}/edit" class="dropdown-item has-icon">
                    <i class="fas fa-cog"></i> {{ trans('oraclepopupsignin/main.change_password') }}
                </a>

                <div class="dropdown-divider"></div>
                <a href="/oraclepopupsignin/logout" class="dropdown-item has-icon text-danger">
                    <i class="fas fa-sign-out-alt"></i> {{ trans('oraclepopupsignin/main.logout') }}
                </a>
            </div>
        </li>
    </ul>
