...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{trans('oraclepopupsignin/main.reviews')}}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{trans('oraclepopupsignin/main.dashboard')}}</a>
                </div>
                <div class="breadcrumb-item">{{trans('oraclepopupsignin/main.reviews')}}</div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.total_reviews')}}</h4>
                        </div>
                        <div class="card-body">
                            {{ $totalReviews }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.published_reviews')}}</h4>
                        </div>
                        <div class="card-body">
                            {{ $publishedReviews }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.rates_average')}}</h4>
                        </div>
                        <div class="card-body">
                            {{ $ratesAverage }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('oraclepopupsignin/main.classes_without_review')}}</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control populate">
                                        ...
                                        <option value="pending" @if(request()->get('status') == 'pending') selected @endif>{{trans('oraclepopupsignin/main.hidden')}}</option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <table class="table table-striped font-14" id="datatable-details">
                        ...
                        <tr>
                            ...
                            <th class="">{{trans('oraclepopupsignin/main.comment')}}</th>
                            <th class="">{{trans('oraclepopupsignin/main.rate')}} (5)</th>
                            <th class="">{{trans('oraclepopupsignin/main.created_at')}}</th>
                            <th class="">{{trans('oraclepopupsignin/main.status')}}</th>
                            <th class="">{{trans('oraclepopupsignin/main.actions')}}</th>
                        </tr>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    @if($review->status == 'active')
                                        <b class="f-w-b text-success">{{trans('oraclepopupsignin/main.published')}}</b>
                                    @else
                                        <b class="f-w-b text-warning">{{trans('oraclepopupsignin/main.hidden')}}</b>
                                    @endif
                                </td>
                                <td class="" width="50">
                                    @can('admin_reviews_status_toggle')
                                        <a href="/oraclepopupsignin/reviews/{{ $review->id }}/toggleStatus" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ ($review->status == 'active') ? 'Hidden' : 'Publish' }}">
                                            @if($review->status == 'active')
                                    ...
                                    @can('admin_reviews_delete')
                                        @include('admin.includes.delete_button',['url' => '/oraclepopupsignin/reviews/'. $review->id.'/delete','btnClass' => ''])
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="contactMessageLabel">{{trans('oraclepopupsignin/main.view_rates_details')}}</h5>
