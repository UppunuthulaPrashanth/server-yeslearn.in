...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.create_trend_category') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{trans('oraclepopupsignin/main.dashboard')}}</a>
                </div>
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.create_trend_category') }}</div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card mt-4">
                        <div class="card-body">
                            <form action="/oraclepopupsignin/categories/trends/{{ !empty($trend) ? $trend->id.'/update' : 'store' }}"
                                  method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label class="input-label">{{ trans('oraclepopupsignin/main.trend_icon') }}</label>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('oraclepopupsignin/main.trend_color') }}</label>
                                    ...
                                    <div class="input-group colorpickerinput">
                                        <input type="text" name="color"
                                               ...
                                               placeholder="{{ trans('oraclepopupsignin/main.trend_color_placeholder') }}"
                                        />
