                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <form action="/oraclepopupsignin/rewards/settings" method="post">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="rewardsStatusSwitch">{{ trans('oraclepopupsignin/main.active') }}</label>
                                            </label>
