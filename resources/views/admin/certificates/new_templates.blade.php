...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.new_template') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{trans('oraclepopupsignin/main.dashboard')}}</a>
                </div>
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.new_template') }}</div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <p class="col">{{ trans('oraclepopupsignin/main.course') }} : [course] </p>

                        <p class="col">{{ trans('quiz.grade') }} : [grade] </p>

                        <p class="col">{{ trans('oraclepopupsignin/main.certificate_id') }} : [certificate_id] </p>
                    </div>
                    ...
                    <form method="post" action="" id="templateForm" class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ trans('oraclepopupsignin/main.template_image') }}</label>
                        ...
                        <div class="row">
                            <dov class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">{!! trans('oraclepopupsignin/main.position_x') !!}</label>
                            ...
                            <dov class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">{!! trans('oraclepopupsignin/main.position_y') !!}</label>
                            ...
                            <dov class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">{!! trans('oraclepopupsignin/main.font_size') !!}</label>
                            ...
                            <dov class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">{!! trans('oraclepopupsignin/main.text_color') !!}</label>
                        ...
                        <div class="form-group ">
                            <label class="control-label" for="inputDefault">{{ trans('oraclepopupsignin/main.message_body') }}</label>
                        ...
                        <div class="form-group custom-switches-stacked">
                            <label class="custom-switch">
                                ...
                                <label class="custom-switch-description mb-0 cursor-pointer" for="rtl">{{ trans('oraclepopupsignin/main.rtl') }}</label>
                            </label>
                        </div>
                        ...
                        <div class="form-group custom-switches-stacked">
                            <label class="custom-switch">
                                ...
                                <span class="custom-switch-indicator"></span>
                                <label class="custom-switch-description mb-0 cursor-pointer" for="status">{{ trans('oraclepopupsignin/main.active') }}</label>
                            </label>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12">
                                <button class="btn btn-success pull-left" id="submiter" type="button" data-action="{{ !empty($template) ? '/oraclepopupsignin/certificates/templates/'. $template->id .'/update' : '/oraclepopupsignin/certificates/templates/store' }}">{{ trans('public.save') }}</button>
                                <button class="btn btn-info pull-left" id="preview" type="button" data-action="/oraclepopupsignin/certificates/templates/preview">{{ trans('oraclepopupsignin/main.preview_certificate') }}</button>
                            </div>
                        </div>
