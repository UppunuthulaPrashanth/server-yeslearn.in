...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.certificates') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{trans('oraclepopupsignin/main.dashboard')}}</a>
                </div>
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.certificates') }}</div>
            </div>
        </div>
        ...
        <div class="section-body">
            <section class="card">
                <div class="card-body">
                    <form action="/oraclepopupsignin/certificates" method="get" class="row mb-0">
                        ...
                        <div class="card-header">
                            @can('admin_certificate_export_excel')
                                <div class="text-right">
                                    <a href="/oraclepopupsignin/certificates/excel?{{ http_build_query(request()->all()) }}" class="btn btn-primary">{{ trans('oraclepopupsignin/main.export_xls') }}</a>
                                </div>
                            @endcan
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('oraclepopupsignin/main.grade') }}</th>
                                    ...
                                    @foreach($certificates as $certificate)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/oraclepopupsignin/certificates/{{ $certificate->id }}/download" class="btn-transparent text-primary" data-toggle="tooltip" title="{{ trans('quiz.download_certificate') }}">
