...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.new_package') }}</h1>
        ...
        <div class="section-body card">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="section-title ml-4">{{ !empty($package) ? trans('oraclepopupsignin/main.edit') : trans('oraclepopupsignin/main.create') }}</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card-body">
                        <form action="/oraclepopupsignin/financial/registration-packages/{{ !empty($package) ? $package->id.'/update' : 'store' }}" method="Post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label>{{ trans('oraclepopupsignin/main.short_description') }}</label>
                            ...
                            <div class="form-group">
                                <label>{{ trans('oraclepopupsignin/main.role') }}</label>
                                <select name="role" class="form-control @error('role') is-invalid @enderror">
                                    <option value="">{{ trans('oraclepopupsignin/main.select') }}</option>
                                    <option value="instructors" {{ ((!empty($package) and $package->role == 'instructors') or old('role') == 'instructors') ? 'selected' : '' }}>{{ trans('oraclepopupsignin/main.instructor') }}</option>
                                    <option value="organizations" {{ ((!empty($package) and $package->role == 'organizations') or old('role') == 'organizations') ? 'selected' : '' }}>{{ trans('oraclepopupsignin/main.organization') }}</option>
                                </select>
                                @error('role')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="form-group custom-switches-stacked">
                                <label class="custom-switch pl-0">
                                    ...
                                    <label class="custom-switch-description mb-0 cursor-pointer" for="statusSwitch">{{ trans('oraclepopupsignin/pages/financial.status') }}</label>
                                </label>
                            </div>
