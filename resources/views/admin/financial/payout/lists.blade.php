    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.payouts') }}</div>
            </div>
        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="sort" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="created_at_asc" @if(request()->get('sort') == 'created_at_asc') selected @endif>{{ trans('oraclepopupsignin/main.last_payout_date_ascending') }}</option>
                                        <option value="created_at_desc" @if(request()->get('sort') == 'created_at_desc') selected @endif>{{ trans('oraclepopupsignin/main.last_payout_date_descending') }}</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            @can('admin_payouts_export_excel')
                                <a href="/oraclepopupsignin/webinar/excel" class="btn btn-primary">{{ trans('oraclepopupsignin/main.export_xls') }}</a>
                            @endcan
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th>{{ trans('oraclepopupsignin/main.payout_amount') }}</th>
                                        <th>{{ trans('oraclepopupsignin/main.bank') }}</th>
                                        <th>{{ trans('oraclepopupsignin/main.account_id') }}</th>
                                        <th>{{ trans('oraclepopupsignin/main.iban') }}</th>
                                        <th>{{ trans('oraclepopupsignin/main.phone') }}</th>
                                        <th width="180px">{{ trans('oraclepopupsignin/main.last_payout_date') }}</th>
                                                            ...
                                                            @if($payout->status === \App\Models\Payout::$waiting)
                                                                ...
                                                                @can('admin_payouts_payout')
                                                                    @include('admin.includes.delete_button',[
                                                                            'url' => '/oraclepopupsignin/financial/payouts/'. $payout->id .'/payout',
                                                                            'tooltip' => trans('oraclepopupsignin/main.payout'),
                                                                ...
                                                                @can('admin_payouts_reject')
                                                                    @include('admin.includes.delete_button',[
                                                                            'url' => '/oraclepopupsignin/financial/payouts/'. $payout->id .'/reject',
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{trans('oraclepopupsignin/main.payout_list_hint_title_1')}}</div>
                        <div class=" text-small font-600-bold">{{trans('oraclepopupsignin/main.payout_list_hint_description_1')}}</div>
                    </div>
                </div>

                <div class="col-md-6">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{trans('oraclepopupsignin/main.payout_list_hint_title_2')}}</div>
                        <div class=" text-small font-600-bold">{{trans('oraclepopupsignin/main.payout_list_hint_description_2')}}</div>
                    </div>
                </div>
            </div>
        </div>
