...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('oraclepopupsignin/main.new_factor') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{trans('oraclepopupsignin/main.dashboard')}}</a>
                </div>
                <div class="breadcrumb-item">{{ trans('oraclepopupsignin/main.new_factor') }}</div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="section-title">{{ trans('oraclepopupsignin/main.create') }}</h2>
                </div>
            </div>
                ...
                <div class="col-12 col-md-7">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/oraclepopupsignin/documents/new" method="post">
                                {{ csrf_field() }}

                                <div class="form-group">
                                    <label class="control-label">{{ trans('oraclepopupsignin/main.title') }}</label>
