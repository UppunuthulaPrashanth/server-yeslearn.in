                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-8 col-lg-6">
                            <form action="/oraclepopupsignin/financial/discounts/{{ !empty($discount) ? $discount->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="discount_type" class="js-discount-type form-control @error('discount_type') is-invalid @enderror">
                                        <option value="percentage"{{ (empty($discount) or (!empty($discount) and $discount->discount_type == 'percentage')) ? 'selected' : '' }}>{{ trans('oraclepopupsignin/main.percentage') }}</option>
                                ...
                                <div class="form-group js-courses-input {{ (empty($discount) or $discount->source != \App\Models\Discount::$discountSourceCourse) ? 'd-none' : '' }}">
                                    <label class="input-label">{{ trans('oraclepopupsignin/main.courses') }}</label>
                                ...
                                <div class="form-group js-categories-input {{ (empty($discount) or $discount->source != \App\Models\Discount::$discountSourceCategory) ? 'd-none' : '' }}">
                                    <label class="input-label">{{ trans('oraclepopupsignin/main.categories') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="input-label d-block">{{ trans('oraclepopupsignin/main.groups') }}</label>
                                ...
                                <div class="form-group js-percentage-inputs {{ (!empty($discount) and $discount->discount_type == 'fixed_amount') ? 'd-none' : '' }}">
                                    <label>{{ trans('oraclepopupsignin/main.discount_percentage') }}</label>
                                ...
                                <div class="form-group js-percentage-inputs {{ (!empty($discount) and $discount->discount_type == 'fixed_amount') ? 'd-none' : '' }}">
                                    <label>{{ trans('oraclepopupsignin/main.max_amount') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                ...
                                <div class="form-group js-fixed-amount-inputs {{ (empty($discount) or $discount->discount_type == 'percentage') ? 'd-none' : '' }}">
                                    <label>{{ trans('oraclepopupsignin/main.amount') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <i class="fas fa-dollar-sign"></i>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('oraclepopupsignin/main.usable_times') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                        ...
                                        <input type="number" name="count"
                                               ...
                                               placeholder="{{ trans('oraclepopupsignin/main.count_placeholder') }}"/>
                                        @error('count')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="inputDefault">{{ trans('oraclepopupsignin/main.discount_code') }}</label>
                                    ...
                                    @enderror
                                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.discount_code_hint') }}</div>
                                </div>

                                <div class="form-group">
                                    <label class="input-label">{{ trans('oraclepopupsignin/main.expiration') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
