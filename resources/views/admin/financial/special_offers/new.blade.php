                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-8 col-lg-6">
                            <form action="/oraclepopupsignin/financial/special_offers/{{ !empty($specialOffer) ? $specialOffer->id.'/update' : 'store' }}"
                                  method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name"
                                           ...
                                           placeholder="{{ trans('oraclepopupsignin/main.name_placeholder') }}"/>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    <label>{{ trans('oraclepopupsignin/main.class') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="input-label">{{ trans('oraclepopupsignin/main.from_date') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                ...
                                <div class="form-group">
                                    <label class="input-label">{{ trans('oraclepopupsignin/main.to_date') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="dateRangeLabel">
                                                <i class="fa fa-calendar"></i>
