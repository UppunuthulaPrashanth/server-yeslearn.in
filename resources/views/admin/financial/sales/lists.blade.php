            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('oraclepopupsignin/main.classes_sales')}}</h4>
                            </div>
                            <div class="card-body">
                                {{ $classesSales['count'] }}
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('oraclepopupsignin/main.appointments_sales')}}</h4>
                            </div>
                            <div class="card-body">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('oraclepopupsignin/main.faild_sales')}}</h4>
                            </div>
                            <div class="card-body">
                                {{ $failedSales }}
                            </div>
                ...
                <div class="card-body">
                    <form method="get" class="mb-0">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="success" @if(request()->get('status') == 'success') selected @endif>{{ trans('oraclepopupsignin/main.success') }}</option>
                                        <option value="refund" @if(request()->get('status') == 'refund') selected @endif>{{ trans('oraclepopupsignin/main.refund') }}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="input-label">{{ trans('oraclepopupsignin/main.student') }}</label>
                    ...
                    <div class="card">
                        <div class="card-header">
                            @can('admin_sales_export')
                                <a href="/oraclepopupsignin/financial/sales/export" class="btn btn-primary">{{ trans('oraclepopupsignin/main.export_xls') }}</a>
                            @endcan
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        <th>#</th>
                                        <th class="text-left">{{ trans('oraclepopupsignin/main.student') }}</th>
                                        <th class="text-left">{{ trans('oraclepopupsignin/main.instructor') }}</th>
                                        <th>{{ trans('oraclepopupsignin/main.paid_amount') }}</th>
                                        <th>{{ trans('oraclepopupsignin/main.discount') }}</th>
                                        <th>{{ trans('oraclepopupsignin/main.tax') }}</th>
                                        <th class="text-left">{{ trans('oraclepopupsignin/main.item') }}</th>
                                        <th>{{ trans('oraclepopupsignin/main.sale_type') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($sale->payment_method == \App\Models\Sale::$subscribe)
                                                    <span class="">{{ trans('oraclepopupsignin/main.subscribe') }}</span>
                                                @else
                                            ...
                                            <td>
                                                @if(!empty($sale->refund_at))
                                                    <span class="text-warning">{{ trans('oraclepopupsignin/main.refund') }}</span>
                                                @else
                                                    <span class="text-success">{{ trans('oraclepopupsignin/main.success') }}</span>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @can('admin_sales_invoice')
                                                    @if(!empty($sale->webinar_id))
                                                        <a href="/oraclepopupsignin/financial/sales/{{ $sale->id }}/invoice" target="_blank" title="{{ trans('oraclepopupsignin/main.invoice') }}"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                    @endif
                                                @endcan
                                                ...
                                                @can('admin_sales_refund')
                                                    @if(empty($sale->refund_at) and $sale->payment_method != \App\Models\Sale::$subscribe)
                                                        @include('admin.includes.delete_button',[
                                                                'url' => '/oraclepopupsignin/financial/sales/'. $sale->id .'/refund',
                                                                'tooltip' => trans('oraclepopupsignin/main.refund'),
