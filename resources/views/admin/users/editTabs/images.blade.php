<div class="tab-pane mt-3 fade" id="images" role="tabpanel" aria-labelledby="images-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/oraclepopupsignin/users/{{ $user->id .'/updateImage' }}" method="Post">
                {{ csrf_field() }}

                <div class="form-group mt-15">
                    <label class="input-label">{{ trans('oraclepopupsignin/main.avatar') }}</label>
                ...
                <div class="form-group mt-15">
                    <label class="input-label">{{ trans('oraclepopupsignin/main.cover_image') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
