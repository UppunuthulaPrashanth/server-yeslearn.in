<div class="tab-pane mt-3 fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
    <div class="row">
        <div class="col-12 col-md-8 col-lg-6">
            <form action="/oraclepopupsignin/users/groups/{{ !empty($group) ? $group->id.'/update' : 'store' }}" method="Post">
                {{ csrf_field() }}
                ...
                <div class="form-group ">
                    <label>{{ trans('oraclepopupsignin/main.user_group_commission_rate') }}</label>
                    <div class="input-group">
                        ...
                        <input type="number"
                               ...
                               placeholder="{{ trans('oraclepopupsignin/main.user_group_commission_rate_placeholder') }}" maxlength="3" min="0" max="100">
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.user_group_commission_rate_hint') }}</div>
                </div>

                <div class="form-group ">
                    <label>{{ trans('oraclepopupsignin/main.user_group_discount_rate') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-percentage"></i>
                        ...
                        <input type="number"
                               ...
                               placeholder="{{ trans('oraclepopupsignin/main.user_group_discount_rate_placeholder') }}" maxlength="3" min="0" max="100">
                        @error('discount')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('oraclepopupsignin/main.user_group_discount_rate_hint') }}</div>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="preloadingSwitch">{{ trans('oraclepopupsignin/main.active') }}</label>
                    </label>
                </div>
