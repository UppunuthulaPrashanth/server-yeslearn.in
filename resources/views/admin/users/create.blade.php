...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{!empty($user) ?trans('/oraclepopupsignin/main.edit'): trans('oraclepopupsignin/main.new') }} {{ trans('oraclepopupsignin/main.user') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/oraclepopupsignin/">{{ trans('oraclepopupsignin/main.dashboard') }}</a>
                </div>
                <div class="breadcrumb-item"><a>{{ trans('oraclepopupsignin/main.users') }}</a>
                </div>
                <div class="breadcrumb-item">{{!empty($user) ?trans('/oraclepopupsignin/main.edit'): trans('oraclepopupsignin/main.new') }}</div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-6">
                                    <form action="/oraclepopupsignin/users/store" method="Post">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 @error('role_id') is-invalid @enderror" id="roleId" name="role_id">
                                                <option disabled selected>{{ trans('oraclepopupsignin/main.select_role') }}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                                                <option disabled selected>{{ trans('oraclepopupsignin/main.select_status') }}</option>
