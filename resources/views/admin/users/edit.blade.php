...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('/oraclepopupsignin/main.edit') }} {{ trans('oraclepopupsignin/main.user') }}</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ trans('/oraclepopupsignin/main.edit') }}</div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link @if(empty($becomeInstructor)) active @endif" id="general-tab" data-toggle="tab" href="#general" role="tab" aria-controls="general" aria-selected="true">{{ trans('oraclepopupsignin/main.main_general') }}</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="financial-tab" data-toggle="tab" href="#financial" role="tab" aria-controls="financial" aria-selected="true">{{ trans('oraclepopupsignin/main.financial') }}</a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="badges-tab" data-toggle="tab" href="#badges" role="tab" aria-controls="badges" aria-selected="true">{{ trans('oraclepopupsignin/main.badges') }}</a>
                                </li>
                                ...
                                @if(!empty($becomeInstructor))
                                    <li class="nav-item">
                                        <a class="nav-link @if(!empty($becomeInstructor)) active @endif" id="become_instructor-tab" data-toggle="tab" href="#become_instructor" role="tab" aria-controls="become_instructor" aria-selected="true">{{ trans('oraclepopupsignin/main.become_instructor_info') }}</a>
                                    </li>
                                @endif
                            </ul>
