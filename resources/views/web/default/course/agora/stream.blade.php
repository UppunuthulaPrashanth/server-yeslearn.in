                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="mt-30 text-center">
                            <button type="button" class="btn btn-danger btn-sm" id="leave" data-id="{{ $session->id }}">{{ trans('oraclepopupsignin/main.yes') }}</button>
                            <button type="button" class="btn ml-10 btn-gray btn-sm" data-dismiss="modal">{{ trans('oraclepopupsignin/main.close') }}</button>
                        </div>
                    </div>
                </div>
            </div>
