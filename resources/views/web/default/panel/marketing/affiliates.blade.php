...
@section('content')
        ...
        <div class="activities-container mt-25 p-20 p-lg-35">
            <div class="row">
                ...
                <div class="col-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/default/img/activity/48.svg" width="64" height="64" alt="">
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $referredPartnerUsersCount }}</strong>
    ...
    <section class="mt-25">
        <h2 class="section-title">{{ trans('panel.affiliate_summary') }} <img src="{{$affiliateRank->icon}}" alt="" style="height:40px; border-radius:50px"></h2>

        @if(!empty($referralSettings))
            <div class="mt-15 font-14 text-gray">
                <div class="row">
                    <div class="col-md-4">
                        <p>Plan Name : {{$affiliateRank->label}}</p>
                        <p>Description : {{$affiliateRank->Description}}</p>
                    </div>
                    <div class="col-md-4">
                        <p>Direct commission on sale : {{$affiliateRank->direct_commi}} %</p>
                        <p>Partner commission on sale : {{$affiliateRank->partner_commi}} %</p>
                    </div>
                
                <div class="col-md-4">
                    <p>{{ trans('panel.your_affiliate_code') }}: <span class="btn btn-warning btn-sm">{{ $affiliateCode->code }}</button></p>
